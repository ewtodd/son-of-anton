...
def worker_loop(worker_id: int, renco_home: str, result_file: str) -> None:
...
def reclaimer_loop(renco_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="renco_mixed_stress_")
    print(f"RENCO_HOME = {home}")
