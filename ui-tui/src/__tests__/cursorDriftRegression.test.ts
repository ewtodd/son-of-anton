 ...
 *
 * Symptom: in `renco --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@renco/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using renco --tui and as i type multiline my caret at the end will often ' +
