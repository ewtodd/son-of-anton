...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|renco):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.rencoDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.rencoDesktop?.openExternal?.(href)
  }
}
 ...
 * doesn't cost a context switch out of Renco, and it is the surface the agent
