...
export function getStatus(): Promise<StatusResponse> {
  return rencoApi<StatusResponse>({
    ...profileScoped(),
    path: '/api/status'
  })
}
...
export function getLogs(params: {
  ...
  return rencoApi<LogsResponse>({
    ...profileScoped(),
    path: suffix ? `/api/logs?${suffix}` : '/api/logs'
  })
}

export function getRencoConfig(profile?: string): Promise<RencoConfig> {
  return rencoApi<RencoConfig>({
...
export function getRencoConfigRecord(profile?: ProfileScope): Promise<RencoConfigRecord> {
  return window.rencoDesktop.api<RencoConfigRecord>({
    ...capabilityScoped(profile),
    path: '/api/config'
  })
}

export function getRencoConfigDefaults(): Promise<RencoConfigRecord> {
  return rencoApi<RencoConfigRecord>({
    ...profileScoped(),
...
export function getRencoConfigSchema(profile?: null | string): Promise<ConfigSchemaResponse> {
  return rencoApi<ConfigSchemaResponse>({
    ...profileScoped(profile),
    path: '/api/config/schema'
  })
}

export function saveRencoConfig(config: RencoConfigRecord, profile?: null | string): Promise<{ ok: boolean }> {
...
export function getEnvVars(profile?: null | string): Promise<Record<string, EnvVarInfo>> {
  return rencoApi<Record<string, EnvVarInfo>>({
    ...profileScoped(profile),
    path: '/api/env'
  })
}
...
export function revealEnvVar(key: string, profile?: ProfileScope): Promise<{ key: string; value: string }> {
  return window.rencoDesktop.api<{ key: string; value: string }>({
    ...capabilityScoped(profile),
    path: '/api/env/reveal',
    method: 'POST',
    body: { key }
...
export function validateProviderCredential(
  ...
  return rencoApi<{ ok: boolean; reachable: boolean; message: string; models?: string[] }>({
    ...profileScoped(),
...
export function getCustomEndpoints(): Promise<CustomEndpointsResponse> {
  return rencoApi<CustomEndpointsResponse>({
    ...profileScoped(),
...
export function validateCustomEndpoint(endpoint: CustomEndpointUpdate): Promise<CustomEndpointValidationResponse> {
  return rencoApi<CustomEndpointValidationResponse>({
...
export function listOAuthProviders(): Promise<OAuthProvidersResponse> {
  return rencoApi<OAuthProvidersResponse>({
    ...profileScoped(),
...
export function disconnectOAuthProvider(providerId: string): Promise<{ ok: boolean; provider: string }> {
  return rencoApi<{ ok: boolean; provider: string }>({
    ...profileScoped(),
...
export function startOAuthLogin(providerId: string, profile?: ProfileScope): Promise<OAuthStartResponse> {
  return window.rencoDesktop.api<OAuthStartResponse>({
    ...capabilityScoped(profile),
...
export function submitOAuthCode(providerId: string, sessionId: string, code: string): Promise<OAuthSubmitResponse> {
  return rencoApi<OAuthSubmitResponse>({
    ...profileScoped(),
...
export function pollOAuthSession(
  ...
  return window.rencoDesktop.api<OAuthPollResponse>({
    ...capabilityScoped(profile),
