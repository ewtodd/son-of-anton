...
(``~/.renco/plans/god-file-decomposition.md``, Phase 3 mechanical mixin lifts).
...
class GatewayAuthorizationMixin:
    ...
    def _adapter_group_has_sender_allowlist(
        ...
        *,
        ...
        restricting which senders inside that group can invoke Renco. If such a
    ...
    def _is_user_authorized(
        ...
        *,
        ...
        # (renco gateway pairing approve / the authenticated dashboard) — an
