 ...
 * `window.__RENCO_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Renco brand in the top bar
 ...
 *  `window.__RENCO_PLUGINS__.registerSlot(...)`.
 *
