"""Tests for the ``renco prompt-size`` diagnostic (issue #34667)."""
...
from renco_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(renco_home, memory_text="", user_text=""):
    mem_dir = renco_home / "memories"
...
def _seed_skill(renco_home, name, description):
    skill_dir = renco_home / "skills" / "demo" / name
