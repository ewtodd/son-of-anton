...
// even though a fresh shell — and the Renco CLI — sees it immediately. The
// desktop's RENCO_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\renco. Reading
...
//       RENCO_HOME    REG_SZ    F:\Renco\data
//
