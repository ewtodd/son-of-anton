"""Language Server Protocol (LSP) integration for Son of Anton Agent.

Son of Anton runs full language servers (pyright, gopls, rust-analyzer,
...
def get_service() -> Optional[LSPService]:
    ...
    with _service_lock:
        ...
        if not _atexit_registered:
            ...
            # ``son-of-anton chat`` exit would leak pyright processes that
