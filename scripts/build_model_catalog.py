#!/usr/bin/env python3
"""Build the Son of Anton Model Catalog — a centralized JSON manifest of curated models.
...
Son of Anton CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Son of Anton release.
...
``https://son-of-anton.nousresearch.com/docs/api/model-catalog.json``
"""
...
# Ensure SON_OF_ANTON_HOME is set for imports that touch it at module level.
os.environ.setdefault("SON_OF_ANTON_HOME", os.path.join(os.path.expanduser("~"), ".son-of-anton"))

from son_of_anton_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "son-of-anton repo",
            "docs": "https://son-of-anton.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Son of Anton '
