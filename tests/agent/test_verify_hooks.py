...
The `pre_verify` user-hook aggregation lives in `son_of_anton_cli.plugins`
(`get_pre_verify_continue_message`) and is tested in
`tests/son_of_anton_cli/test_plugins.py`, alongside `get_pre_tool_call_block_message`.
"""
