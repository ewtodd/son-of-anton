...
Keeps the ACP server tests offline: ``RencoACPAgent._build_model_state``
calls ``renco_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import renco_cli.inventory as inventory
