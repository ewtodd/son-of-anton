...
await build({
  ...
  // Skip the prebuilt @sonofanton/ink bundle and inline the source instead:
  ...
  alias: { '@sonofanton/ink': resolve(root, 'packages/son-of-anton-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The son_of_anton_cli launcher
