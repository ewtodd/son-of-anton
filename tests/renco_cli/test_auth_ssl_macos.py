"""Tests for renco_cli.auth._default_verify platform-aware fallback.
...
from renco_cli.auth import _default_verify, _resolve_verify
...
class TestResolveVerifyIntegration:
    ...
    def test_no_ca_uses_default_verify_on_linux(self, monkeypatch):
        for var in ("RENCO_CA_BUNDLE", "SSL_CERT_FILE", "REQUESTS_CA_BUNDLE"):
    ...
    def test_insecure_wins_over_everything(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setenv("RENCO_CA_BUNDLE", str(bundle))
