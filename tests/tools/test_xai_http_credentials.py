...
def test_prefer_api_key_honors_renco_xai_base_url_with_validation(monkeypatch):
    """The preferred-key path reads the same override pair as the OAuth
    branch (RENCO_XAI_BASE_URL first, then XAI_BASE_URL) behind the same
    ...
    monkeypatch.setattr(
        ...
        lambda name, default=None: {
            ...
            "RENCO_XAI_BASE_URL": "https://staging.x.ai/v1",
