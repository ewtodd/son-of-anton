...
// by main.ts (`setBackgroundThrottling` driven by the merged `renco:active-work`
...
// (the "Renco idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Renco" wake word has NO preceding click,
