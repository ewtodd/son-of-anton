"""Son of Anton skin/theme engine — the theme SDK for every surface.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Son of Anton Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ Son of Anton "       # Response box header label
...
.. code-block:: python
    ...
    from son_of_anton_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Son of Anton Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.son-of-anton/skins/
...
class SkinConfig:
    ...
    banner_hero: str = ""    # Rich-markup hero art (replaces SON_OF_ANTON_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "colors": {
            ...
            "status_bar_bad": "red",
            "status_bar_critical": "bold red",
            "session_label": "yellow",
            "session_border": "default",
