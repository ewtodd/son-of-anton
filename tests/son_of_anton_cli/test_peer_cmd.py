"""Tests for ``son-of-anton peer`` — cross-machine bot-to-bot DMs."""
...
from son_of_anton_cli.subcommands import peer as peer_cmd
...
class _FakePeer(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        if self.path == "/api/sessions":
            ...
            return self._json({"object": "son-of-anton.session", "session": {"id": "bc_1", "title": body.get("title")}}, 201)
