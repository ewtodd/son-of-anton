"""
Skills configuration for Son of Anton Agent.
...
from son_of_anton_cli.config import cfg_get, load_config, save_config
from son_of_anton_cli.colors import Colors, color
from son_of_anton_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `son-of-anton skills`."""
    from son_of_anton_cli.curses_ui import curses_checklist
