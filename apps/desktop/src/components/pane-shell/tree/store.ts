...
const STORAGE_KEY = 'renco.desktop.layoutTree.v2'

writeKey('renco.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('renco.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('renco.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'renco.desktop.dismissedPanes.v1'
...
const PANE_SHARE_KEY = 'renco.desktop.paneShare.v1'
...
const HIDDEN_STRIP_TAB_KEY = 'renco.desktop.hiddenStripTabs.v1'
...
writeKey('renco.desktop.paneDockHeals.v1', null)
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__RENCO_LAYOUT_TREE__ = {
    close: closeTreePane,
