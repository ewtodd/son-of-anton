"""Core NeMo Relay adapter for Renco tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Renco tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Renco Relay tool execution cannot run on an active event-loop thread"
    )
