...
import { Box, Text, useInput } from '@sonofanton/ink'
...
function OverviewScreen({ ctx, onClose, onPatch, s, t }: ScreenProps) {
  ...
  const note = !s.is_admin
    ...
    : !s.cli_billing_enabled
      ? "Remote spending is off for this org — a billing admin can turn it on from the portal's Son of Anton Agent page."
      : null
