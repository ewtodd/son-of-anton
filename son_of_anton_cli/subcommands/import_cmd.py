"""``son-of-anton import`` subcommand parser.
...
def build_import_cmd_parser(subparsers, *, cmd_import: Callable) -> None:
    ...
    import_parser = subparsers.add_parser(
        "import",
        help="Restore a Son of Anton backup from a zip file",
        description="Extract a previously created Son of Anton backup into your "
        "Son of Anton home directory, restoring configuration, skills, "
        "sessions, and data",
    )
