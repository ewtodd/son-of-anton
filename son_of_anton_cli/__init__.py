"""
Son of Anton CLI - Unified command-line interface for Son of Anton Agent.

Provides subcommands for:
- son-of-anton chat          - Interactive chat (same as ./son-of-anton)
- son-of-anton gateway       - Run gateway in foreground
- son-of-anton gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `son-of-anton setup` on a fresh Pi.
    ...
    son_of_anton_cli/stdio.py::configure_windows_stdio() runs later from the entry
