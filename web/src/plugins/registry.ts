 ...
 *
 * Plugins call window.__RENCO_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__RENCO_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__RENCO_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__RENCO_PLUGIN_SDK__ = {
    ...
    // window.__RENCO_SESSION_TOKEN__ directly.
    authedFetch,
