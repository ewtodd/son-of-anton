/**
 * Renco Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__RENCO_PLUGIN_SDK__`` and
 * ``window.__RENCO_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__RENCO_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``RencoPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@renco/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__RENCO_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__RENCO_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__RENCO_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface RencoPluginSDK {
...
declare global {
  interface Window {
    __RENCO_PLUGIN_SDK__?: RencoPluginSDK;
    __RENCO_PLUGINS__?: PluginRegistry;
  }
}
