"""The `son-of-anton` skill is what a running Son of Anton knows about itself.

`website/` is never packaged, so an installed Son of Anton has no local copy of the
user guide; skills ARE synced into `$SON_OF_ANTON_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "Son of Anton can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "son-of-anton"
