"""Windows installer regression for Son of Anton children outside the venv.

The venv sweep deliberately selects process roots by executable path so it
does not kill unrelated Python processes. A selected Son of Anton process can spawn
...
def test_venv_sweep_stops_managed_runtime_children_but_not_unrelated_processes(
    ...
    install_dir = son_of_anton_home / "son-of-anton"
    venv_scripts = install_dir / "venv" / "Scripts"
    runtime_dir = son_of_anton_home / ".son-of-anton-runtime" / "python" / "generation-test"
    ...
    # Keep the test away from real gateway tasks and real Son of Anton launchers
