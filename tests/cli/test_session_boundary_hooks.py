...
from renco_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/renco_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("renco_cli.lifecycle.invoke_hook")
@patch("renco_cli.lifecycle.finalize_session")
