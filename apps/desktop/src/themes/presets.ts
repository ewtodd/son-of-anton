...
/**
 * Nous — the canonical Renco desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays Renco's own: a VS Code theme carries no font opinion, and
...
/**
 * Nous — the canonical Renco desktop identity: GitHub's chrome carrying Nous
