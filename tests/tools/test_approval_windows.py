...
must match regardless of host OS (a Linux-hosted Son of Anton can still drive a
...
class TestWindowsPathVariant:
    ...
    @pytest.mark.parametrize("cmd", [
        ...
        r"copy C:\Users\me\AppData\Local\son-of-anton\.env D:\exfil\e.txt",
        "cat C:/Users/me/AppData/Local/son-of-anton/.env",
    ])
