...
_PATTERNS: List[Tuple[str, str, str]] = [
    ...
    (r'unset\s+\w*(?:CLAUDE|CODEX|SON_OF_ANTON|AGENT|OPENAI|ANTHROPIC)\w*', "env_var_unset_agent", "context"),
    ...
    (r'\$HOME/\.son-of-anton/\.env|\~/\.son-of-anton/\.env', "son_of_anton_env", "strict"),
    ...
    (r'(update|modify|edit|write|change|append|add\s+to)\s+[^\n]{0,2048}\.son-of-anton/(config\.yaml|SOUL\.md)', "son_of_anton_config_mod", "strict"),
...
def scan_for_threats(content: str, scope: str = "context") -> List[str]:
    ...
    # bypassing keyword checks (e.g. ``ｃａｔ ~/.son-of-anton/.env``).  NOTE: this
