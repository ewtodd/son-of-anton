...
Data file: $RENCO_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_RENCO_HOME = Path(os.environ.get("RENCO_HOME", Path.home() / ".renco"))
DATA_DIR = _RENCO_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
