...
const TAKEOVER_KEY = 'renco.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Renco can't clear via the API — the user
 *  sees exactly what runs instead of Renco silently deleting their creds. */
