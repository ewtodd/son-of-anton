...
part of the bundled-plugins set; a stock renco-agent install does not see
an "Example" tab in its sidebar. The ``_install_example_plugin`` pytest
fixture in ``tests/renco_cli/test_web_server.py`` copies this directory
into ``$RENCO_HOME/plugins/example-dashboard/`` and forces the dashboard
