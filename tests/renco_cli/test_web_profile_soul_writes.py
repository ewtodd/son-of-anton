...
def client(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("RENCO_DASHBOARD_SESSION_TOKEN", "soul-test-token")
...
def profile_dir(tmp_path, monkeypatch) -> Path:
    """Create a real profile directory under the test RENCO_HOME."""
    monkeypatch.setenv("RENCO_HOME", str(tmp_path))
...
class TestSoulWriteDurability:
    ...
    def test_existing_soul_survives_an_interrupted_save(
        ...
        # RENCO_HOME patch the client/profile_dir fixtures installed.
