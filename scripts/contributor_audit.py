...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Renco\s+(Agent|Audit)$", re.IGNORECASE),
    ...
    re.compile(r".*\[bot\]$", re.IGNORECASE),             # any GitHub [bot] suffix (renco-seaeye[bot] etc.)
...
IGNORED_EMAILS = {
    ...
    "renco@nousresearch.com",
    "renco-audit@example.com",
    "nousbot@nousresearch.com",
    "renco@habibilabs.dev",
    "omx@oh-my-codex.dev",
    "codex@openai.com",
