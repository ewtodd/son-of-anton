"""Tests for the unified provider catalog (son_of_anton_cli.provider_catalog).

These are invariant tests, not snapshots: they assert the parity *contract*
between what ``son-of-anton model`` shows (``CANONICAL_PROVIDERS``) and what the
...
from son_of_anton_cli.provider_catalog import (
    ProviderDescriptor,
    provider_catalog,
