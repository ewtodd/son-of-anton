...
```bash
python ~/.renco/skills/migration/openclaw-migration/scripts/openclaw_to_renco.py
```

When using the terminal tool, prefer an absolute invocation pattern such as:

```json
{"command":"python /home/USER/.renco/skills/migration/openclaw-migration/scripts/openclaw_to_renco.py","workdir":"/home/USER"}
```

Dry run with the user-data preset:

```bash
python ~/.renco/skills/migration/openclaw-migration/scripts/openclaw_to_renco.py --preset user-data
```

Execute a user-data migration:

```bash
python ~/.renco/skills/migration/openclaw-migration/scripts/openclaw_to_renco.py --execute --preset user-data --skill-conflict skip
```

Execute a full compatible migration:

```bash
python ~/.renco/skills/migration/openclaw-migration/scripts/openclaw_to_renco.py --execute --preset full --migrate-secrets --skill-conflict skip
```

Execute with workspace instructions included:

```bash
python ~/.renco/skills/migration/openclaw-migration/scripts/openclaw_to_renco.py --execute --preset user-data --skill-conflict rename --workspace-target "/absolute/workspace/path"
```
