"""Regression: ``renco update`` should take a managed checkout off autocrlf=true.
...
``renco update`` has to repair them.
...
from renco_cli.update_cmd import _normalize_managed_eol
