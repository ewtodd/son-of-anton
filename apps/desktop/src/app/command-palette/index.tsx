...
import { getRencoConfigRecord, listAllProfileSessions } from '@/renco'
...
// Renco session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-renco',
            keywords: ['update', 'upgrade', 'renco', 'version', 'system', 'restart'],
            label: cc.updateRenco,
