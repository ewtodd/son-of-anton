...
class TestGetCopilotModelContext:
    ...
    @patch("renco_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("renco_cli.models._urlopen_model_catalog_request")
    ...
    @patch("renco_cli.models.fetch_github_model_catalog", return_value=[])
