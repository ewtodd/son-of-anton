"""``son-of-anton debug`` subcommand parser.
...
def build_debug_parser(subparsers, *, cmd_debug: Callable) -> None:
    ...
    debug_parser = subparsers.add_parser(
        ...
        description="Debug utilities for Son of Anton Agent. Use 'son-of-anton debug share' to "
        "upload a debug report (system info + recent logs) to a paste "
        "service and get a shareable URL.",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""\
Examples:
    son-of-anton debug share              Upload debug report (asks for confirmation)
    son-of-anton debug share --yes        Skip confirmation (for scripts/CI)
    son-of-anton debug share --lines 500  Include more log lines
    son-of-anton debug share --expire 30  Keep paste for 30 days
    son-of-anton debug share --local      Print report locally (no upload)
    son-of-anton debug share --no-redact  Disable upload-time secret redaction
    son-of-anton debug share --nous       Upload to Nous-internal storage (private)
    son-of-anton debug delete <url>       Delete a previously uploaded paste
""",
    )
    ...
    delete_parser = debug_sub.add_parser(
        "delete",
        help="Delete a paste uploaded by 'son-of-anton debug share'",
    )
