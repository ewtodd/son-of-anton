...
Damien's incident (Discord, 2026-05-28): a long Son of Anton session in a Discord
...
def _make_legacy_session_db_class() -> type:
    ...
    imports the same still-loaded ``son_of_anton_state`` module, whose ``SessionDB``
    ...
    namespace = {"__name__": "son_of_anton_state"}
    source = '''
class SessionDB:
...
_NominalSessionDBImpostor.__module__ = "son_of_anton_state"
