...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and renco-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # renco-agent (tests/skills/)
]
