...
| | |
|---|---|
| Source | Optional — install with `renco skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`renco-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-renco-agent), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
Renco Agent via the native MCP client. This is the preferred
...
Then configure Renco Agent to connect via HTTP:
