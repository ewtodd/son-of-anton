...
// `message.content.text` before Son of Anton can see it. We rewrite the two inbound
...
const MARKER = "Son of Anton patch: Preserve mixed text + attachment iMessage payloads";
