...
import type { RencoGitBranch } from '@/global'
...
const branchActionLabel = (branch: RencoGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<RencoGitBranch[]>([])
  ...
  const convert = async (branch: RencoGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
