...
class TestXiaomiCredentials:
    ...
    def test_resolve_credentials_reads_home_external_secret_scope(
        ...
        from son_of_anton_cli import env_loader
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in SON_OF_ANTON_OVERLAYS
        overlay = SON_OF_ANTON_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify son-of-anton doctor recognizes Xiaomi env vars."""
