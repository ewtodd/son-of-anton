...
def _make_agent():
    son_of_anton_home = Path(tempfile.mkdtemp(prefix="son-of-anton-test-home-"))
    (son_of_anton_home / "logs").mkdir(parents=True, exist_ok=True)
    with (
        patch(
        ...
        patch("run_agent._son_of_anton_home", son_of_anton_home),
