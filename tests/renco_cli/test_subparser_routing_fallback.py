...
The main() function in renco_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `renco -c model`
...
def _build_parser():
    """Build a minimal replica of the renco top-level parser."""
