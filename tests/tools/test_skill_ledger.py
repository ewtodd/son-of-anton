...
def ledger_env(tmp_path, monkeypatch):
    """Isolated RENCO_HOME + skills dir for skill_manage and the ledger."""
    ...
    monkeypatch.setattr(skill_ledger, "get_renco_home", lambda: home)
    monkeypatch.setattr(skill_usage, "get_renco_home", lambda: home)
...
def test_rollback_refuses_paths_outside_renco_home(ledger_env):
    """A hand-edited ledger entry pointing outside RENCO_HOME must not
