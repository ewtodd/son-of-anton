...
Configuration
-------------
Secret (lives in $SON_OF_ANTON_HOME/.env or the environment):
...
Behavioral settings (live in $SON_OF_ANTON_HOME/mem0.json, set via `son-of-anton memory
setup`):
...
_DEFAULT_USER_ID = "son-of-anton-user"
...
def _load_config() -> dict:
    """Load config from env vars, with $SON_OF_ANTON_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "son-of-anton"),
        "oss": {},
    }
    ...
    config_path = get_son_of_anton_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, son_of_anton_home):
        """Write config to $SON_OF_ANTON_HOME/mem0.json."""
        import json
    ...
    def post_setup(self, son_of_anton_home: str, config: dict) -> None:
        ...
        post_setup(son_of_anton_home, config)
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        self._agent_id = self._config.get("agent_id", "son-of-anton")
