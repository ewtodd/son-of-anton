"""Tests for `son-of-anton curator status` output.
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated SON_OF_ANTON_HOME with real agent-created skills on disk."""
    ...
    from son_of_anton_cli import curator as curator_cli
