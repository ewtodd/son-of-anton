...
from son_of_anton_cli.browser_connect import (
...
class CLICommandsMixin:
    ...
    def _handle_snapshot_command(self, command: str):
        """Handle /snapshot — lightweight state snapshots for Son of Anton config/state.
        ...
        if subcmd in {"list", "ls"}:
            ...
            if not snaps:
                ...
                return
            print(f"  State snapshots ({display_son_of_anton_home()}/state-snapshots/):\n")
    ...
    def _handle_export_command(self, command: str):
        ...
        """
        from son_of_anton_cli.profiles import export_profile, get_active_profile_name
        ...
        try:
            ...
            print("  Share it: the other user runs /import or `son-of-anton profile import <archive>`.")
    ...
    def _handle_import_command(self, command: str):
        ...
        try:
            ...
            pass
        print(f"  Use it: son-of-anton -p {imported}")
    ...
    def _handle_journey_command(self, cmd_original: str) -> None:
        """Handle /journey — the learning timeline (see `son-of-anton journey`).
        ...
        from cli import _cprint
        from son_of_anton_cli.journey import register_cli
    ...
    def _handle_handoff_command(self, cmd_original: str) -> bool:
        ...
        try:
            ...
            pass
        _cprint("  Timed out waiting for the gateway. Is `son-of-anton gateway` running?")
    ...
    def _handle_personality_command(self, cmd: str):
        ...
        if len(parts) > 1:
            ...
            if not name:
                ...
                try:
                    from son_of_anton_cli.config import cfg_get, read_raw_config
    ...
    def _handle_pet_command(self, cmd: str):
        ...
        from son_of_anton_cli.pets import _set_active, _set_enabled, print_pet_gallery, set_pet_scale, toggle_pet_display
    ...
    def _handle_kanban_command(self, cmd: str):
        ...
        """
        from son_of_anton_cli.kanban import run_slash
        ...
        if sub.startswith("connect"):
            ...
            if hasattr(self, '_pending_input'):
                self._pending_input.put(
                    ...
                    "just because CDP is connected. This is typically a Son of Anton-managed isolated debug "
    ...
    def _handle_heartbeat_command(self, cmd: str) -> None:
        ...
        cross-process schedules use `son-of-anton cron`.
        """
        from cli import _DIM, _RST, _cprint
        from son_of_anton_cli.heartbeat import parse_interval, format_interval
        ...
        if interval is None:
            ...
            return
        if interval < 0:
            from son_of_anton_cli.heartbeat import MIN_INTERVAL_SECONDS
        ...
        _cprint(
            ...
            f"lives only while this Son of Anton process runs — use `son-of-anton cron` for "
    ...
    def _handle_loop_command(self, cmd: str) -> None:
        ...
        from son_of_anton_cli.loops import dispatch_loop_command
    ...
    def _handle_fast_command(self, cmd: str):
        ...
        try:
            from son_of_anton_cli.models import _is_anthropic_fast_model
            agent = getattr(self, "agent", None)
    ...
    def _handle_debug_command(self, cmd_original: str = ""):
        ...
        """
        from son_of_anton_cli.debug import run_debug_share
    ...
    def _handle_update_command(self) -> bool:
        """Handle /update — update Son of Anton Agent to the latest version.

        In the classic CLI this exits the session and relaunches as
        ``son-of-anton update`` so the user sees update output directly and gets
        ...
        if is_managed():
            print(f"  ✗ {format_managed_message('update Son of Anton Agent')}")
            return False
        ...
        choices = [
            ("once", "Update Now", "exit the current session and update Son of Anton Agent"),
            ("cancel", "Cancel", "keep the current session"),
        ]
        raw = self._prompt_text_input_modal(
            title="⚕  Update Son of Anton Agent",
            detail="This will exit the current session and run `son-of-anton update`.",
            choices=choices,
        )
        if raw is None:
