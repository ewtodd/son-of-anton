...
When a provider returns a non-OK status on a *streaming* request, Son of Anton reads
...
streams"), generalized to cover Son of Anton's three streaming error-body sites
