"""Tests for the shared byte formatter (son_of_anton_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from son_of_anton_cli.backup import _format_size as backup
    from son_of_anton_cli.checkpoints import _fmt_bytes as checkpoints
    from son_of_anton_cli.doctor import _human_bytes as doctor
