...
SKILLS_GUIDANCE = (
    ...
    "\n"
    "## Skill Safety Rule\n"
    "1. **UNAVAILABLE** — If a skill placeholder contains `[SKILL_PRUNED]`, the skill content was lost in compaction and is inaccessible.\n"
...
def _probe_remote_backend(env_type: str) -> str | None:
    ...
    try:
        ...
        # live command: assemble ssh config from the env-derived dict. (There
        # is no `get_environment` factory — the real entry point is
        # `_create_environment`.)
        image = ""
