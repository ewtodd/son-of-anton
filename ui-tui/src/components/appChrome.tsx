import { Box, type ScrollBoxHandle, stringWidth, Text } from '@sonofanton/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (SON_OF_ANTON_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (SON_OF_ANTON_DEV_CREDITS), lowest priority,
