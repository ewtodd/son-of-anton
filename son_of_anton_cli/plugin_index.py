...
``SON_OF_ANTON_HOME/cache/`` with a TTL, with a bundled seed file as the offline
...
DEFAULT_INDEX_URL = (
    "https://raw.githubusercontent.com/NousResearch/son-of-anton-plugin-index/main/index.json"
)
...
def _cache_path() -> Path:
    return get_son_of_anton_home() / "cache" / "plugin_index.json"
