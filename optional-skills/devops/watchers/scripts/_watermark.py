...
def _state_dir() -> Path:
    ...
    # Default: $RENCO_HOME/watcher-state/, falling back to ~/.renco/watcher-state/.
    renco_home = os.environ.get("RENCO_HOME") or str(Path.home() / ".renco")
    return Path(renco_home) / "watcher-state"
