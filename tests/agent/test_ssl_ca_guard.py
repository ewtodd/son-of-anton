...
def test_healthy_bundle_passes(monkeypatch):
    ...
    for key in ("RENCO_CA_BUNDLE", "SSL_CERT_FILE", "REQUESTS_CA_BUNDLE", "CURL_CA_BUNDLE"):
...
@pytest.mark.parametrize("env_var", ["RENCO_CA_BUNDLE", "SSL_CERT_FILE", "REQUESTS_CA_BUNDLE", "CURL_CA_BUNDLE"])
