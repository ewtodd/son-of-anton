...
def main() -> None:
    ...
    renco_home = Path(tempfile.mkdtemp(prefix="renco-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "renco-gateway-smoke",
    ...
    print(json.dumps({"renco_home": str(renco_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
