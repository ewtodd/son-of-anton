...
SON_OF_ANTON_OVERLAYS keys may be models.dev IDs (e.g. "github-copilot") while
_PROVIDER_MODELS and config.yaml use Son of Anton IDs ("copilot").  The slug
...
def test_copilot_uses_son_of_anton_slug():
...
def test_mapped_provider_credential_pool_visibility(monkeypatch):
    ...
    monkeypatch.setattr(
        "son_of_anton_cli.auth._load_auth_store",
