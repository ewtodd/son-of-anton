...
# ---------------------------------------------------------------------------
# Thread-safe cache entry update (renco_cli/models.py)
# ---------------------------------------------------------------------------
...
class TestUpdateProviderCacheEntry:
    ...
    def test_writes_new_entry(self, tmp_path, monkeypatch):
        ...
        import renco_cli.models as mod
...
# ---------------------------------------------------------------------------
# Parallel prefetch (renco_cli/model_switch.py)
# ---------------------------------------------------------------------------
...
class TestPrefetchProviderModelsParallel:
    ...
    def test_skips_all_fresh_entries(self, monkeypatch):
        ...
        from renco_cli.model_switch import _prefetch_provider_models_parallel
        ...
        with patch("renco_cli.models._load_provider_models_cache", return_value=fresh_cache), \
             patch("renco_cli.models._credential_fingerprint", return_value="fp"), \
             patch("renco_cli.models.cached_provider_model_ids") as fetch:
    ...
    def test_fetches_only_stale_entries(self, monkeypatch):
        ...
        with patch("renco_cli.models._load_provider_models_cache", return_value=cache), \
             patch("renco_cli.models._credential_fingerprint", return_value="fp_f"), \
             patch("renco_cli.models.cached_provider_model_ids", side_effect=mock_fetch), \
             patch("renco_cli.models.update_provider_cache_entry"):
    ...
    def test_fetches_in_parallel(self, monkeypatch):
        ...
        with patch("renco_cli.models._load_provider_models_cache", return_value={}), \
             patch("renco_cli.models._credential_fingerprint", return_value="fp"), \
             patch("renco_cli.models.cached_provider_model_ids", side_effect=mock_fetch), \
             patch("renco_cli.models.update_provider_cache_entry"):
    ...
    def test_empty_list_is_noop(self):
        ...
        with patch("renco_cli.models.cached_provider_model_ids") as fetch:
...
class TestPrefetchIntegration:
    ...
    def test_prefetch_called_with_more_than_3_providers(self):
        ...
        from renco_cli import model_switch
