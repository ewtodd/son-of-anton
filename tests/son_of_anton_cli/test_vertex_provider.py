...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (son_of_anton_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_son_of_anton_overlays():
    """son_of_anton_cli.providers.get_provider("vertex") backs
