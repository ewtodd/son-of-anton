...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/renco-agent')).toBe('~/www/renco-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/renco-agent')).toBe('renco-agent')
    expect(pathLeaf('~/www/renco-agent')).toBe('renco-agent')
