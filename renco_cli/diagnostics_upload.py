"""Client for uploading ``renco debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``renco debug share``.
...
NAS_BASE = os.environ.get(
    "RENCO_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "renco-agent/debug-share"
