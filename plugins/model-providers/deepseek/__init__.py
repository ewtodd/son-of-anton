...
the contract that subsequent turns echo it back; combined with how Son of Anton
...
2026-07-24.  Use ``deepseek-v4-flash`` or ``deepseek-v4-pro``; Son of Anton remaps
the retired IDs in ``son_of_anton_cli.model_normalize``.
"""
...
def _model_supports_thinking(model: str | None) -> bool:
    ...
    before requests leave Son of Anton, so they are not listed here.
    """
