...
Usage:
    son-of-anton pairing list              # Show all pending + approved users
    son-of-anton pairing approve <platform> <request-id|code>  # Approve a pairing request
    son-of-anton pairing revoke <platform> <user_id> # Revoke user access
    son-of-anton pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle son-of-anton pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: son-of-anton pairing {list|approve|revoke|clear-pending}")
        print("Run 'son-of-anton pairing --help' for details.")
...
def _cmd_list(store):
    ...
    if pending:
        ...
        print("\n  Approve with: son-of-anton pairing approve <platform> <request-id>")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.son-of-anton/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Pairing request or code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'son-of-anton pairing list' to see pending requests.\n")
