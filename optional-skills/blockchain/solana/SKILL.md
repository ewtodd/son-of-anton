...
python ~/.renco/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python ~/.renco/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python ~/.renco/skills/blockchain/solana/scripts/solana_client.py price BONK
python ~/.renco/skills/blockchain/solana/scripts/solana_client.py price JUP
python ~/.renco/skills/blockchain/solana/scripts/solana_client.py price SOL
python ~/.renco/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
