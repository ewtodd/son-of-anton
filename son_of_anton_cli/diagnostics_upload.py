"""Client for uploading ``son-of-anton debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``son-of-anton debug share``.
...
NAS_BASE = os.environ.get(
    "SON_OF_ANTON_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "son-of-anton/debug-share"
