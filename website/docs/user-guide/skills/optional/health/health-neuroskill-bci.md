...
| | |
|---|---|
| Source | Optional — install with `renco skills install official/health/neuroskill-bci` |
...
Connect Renco to a running [NeuroSkill](https://neuroskill.com/) instance to read
