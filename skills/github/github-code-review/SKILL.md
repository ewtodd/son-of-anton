...
curl -s -X POST \
  ...
  -d "{
    \"commit_id\": \"$HEAD_SHA\",
    \"event\": \"COMMENT\",
    \"body\": \"Code review from Son of Anton Agent\",
    \"comments\": [
...
```bash
source "${SON_OF_ANTON_HOME:-$HOME/.son-of-anton}/skills/github/github-auth/scripts/gh-env.sh"
...
gh pr review $PR_NUMBER --approve --body "Reviewed by Son of Anton Agent. Code looks clean — good test coverage, no security concerns."
...
curl -s -X POST \
  ...
  -d "{
    ...
    \"body\": \"## Son of Anton Agent Review\n\nFound 2 issues, 1 suggestion. See inline comments.\",
    \"comments\": [
