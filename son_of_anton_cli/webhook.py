"""son-of-anton webhook — manage dynamic webhook subscriptions from the CLI.

Usage:
    son-of-anton webhook subscribe <name> [options]
    son-of-anton webhook list
    son-of-anton webhook remove <name>
    son-of-anton webhook test <name> [--payload '{"key": "value"}']

Subscriptions persist to ~/.son-of-anton/webhook_subscriptions.json and are
...
def _subscriptions_path() -> Path:
    return _son_of_anton_home() / _SUBSCRIPTIONS_FILENAME
...
def _setup_hint() -> str:
    _dhh = display_son_of_anton_home()
    return f"""
  ...
  Then start the gateway: son-of-anton gateway run
"""
...
def webhook_command(args):
    """Entry point for 'son-of-anton webhook' subcommand."""
    sub = getattr(args, "webhook_action", None)

    if not sub:
        print("Usage: son-of-anton webhook {subscribe|list|remove|test}")
        print("Run 'son-of-anton webhook --help' for details.")
        return
...
def _cmd_subscribe(args):
    ...
    print("  The gateway must be running to receive events (son-of-anton gateway run).\n")
...
def _cmd_list(args):
    ...
    if not subs:
        ...
        print("  Create one with: son-of-anton webhook subscribe <name>")
        return
...
def _cmd_test(args):
    ...
    payload = args.payload or '{"test": true, "event_type": "test", "message": "Hello from son-of-anton webhook test"}'
    ...
    try:
        ...
        print(f"  Error: {e}")
        print("  Is the gateway running? (son-of-anton gateway run)")
