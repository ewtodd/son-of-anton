#!/usr/bin/env python3
"""Build the Renco Model Catalog — a centralized JSON manifest of curated models.
...
Renco CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Renco release.
...
# Ensure RENCO_HOME is set for imports that touch it at module level.
os.environ.setdefault("RENCO_HOME", os.path.join(os.path.expanduser("~"), ".renco"))

from renco_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "renco-agent repo",
            "docs": "https://renco-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Renco '
