...
_SESSION_CWD: ContextVar = ContextVar("SON_OF_ANTON_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    # configured path is otherwise honored verbatim — including the Son of Anton
    # source tree itself, which is a legitimate workspace when the user is
    # developing Son of Anton (per-surface policy for fallback-picked directories
