...
const SOURCE_CONFIG: Record<string, { icon: typeof Terminal; color: string }> =
  {
    ...
    renco_flow: { icon: Play, color: "text-warning" },
...
const NO_MATCHING_SESSION_SOURCE = "__renco_dashboard_no_matching_source__";
        ...
        const res = await fetch(api.exportSessionUrl(id), {
          ...
          headers: {
            "X-Renco-Session-Token":
              (window as unknown as { __RENCO_SESSION_TOKEN__?: string })
                .__RENCO_SESSION_TOKEN__ ?? "",
          },
        });
