...
- Give it a name like "son-of-anton"
- Select scopes:
...
- Give it a title like "son-of-anton-<machine-name>"
...
uv run python "${SON_OF_ANTON_HOME:-$HOME/.son-of-anton}/skills/github/github-auth/scripts/git-credential-token.py"
```
...
elif _son_of_anton_env="${SON_OF_ANTON_HOME:-$HOME/.son-of-anton}/.env"; [ -f "$_son_of_anton_env" ] && grep -q "^GITHUB_TOKEN=" "$_son_of_anton_env"; then
  export GITHUB_TOKEN=$(grep "^GITHUB_TOKEN=" "$_son_of_anton_env" | head -1 | cut -d= -f2 | tr -d '\n\r')
  echo "AUTH_METHOD=curl"
elif grep -q "github.com" ~/.git-credentials 2>/dev/null; then
  export GITHUB_TOKEN=$(uv run python "${SON_OF_ANTON_HOME:-$HOME/.son-of-anton}/skills/github/github-auth/scripts/git-credential-token.py")
  echo "AUTH_METHOD=curl"
else
