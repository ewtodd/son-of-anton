...
def test_cli_model_once_records_restore_and_does_not_persist(monkeypatch):
    ...
    stub._snapshot_model_runtime = cli_mod.SonOfAntonCLI._snapshot_model_runtime.__get__(stub)
    printed = []
    ...
    monkeypatch.setattr(
        "son_of_anton_cli.model_switch.switch_model",
    ...
    monkeypatch.setattr("son_of_anton_cli.model_switch.resolve_display_context_length", lambda *a, **k: None)

    cli_mod.SonOfAntonCLI._handle_model_switch(
        stub,
...
def test_cli_restore_model_runtime_snapshot_restores_agent():
    ...
    cli_mod.SonOfAntonCLI._restore_model_runtime_snapshot(stub, snapshot)
