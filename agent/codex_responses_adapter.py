...
def _clamp_responses_call_id(call_id: str) -> str:
    ...
    component the built-in ``son-of-anton-tools`` server already overflows 64 chars,
...
# output items.  Son of Anton injects xAI's native ``web_search`` for the xAI
...
# server-assigned base64 blobs that can run 400+ chars, while Son of Anton-minted
...
def _chat_messages_to_responses_input(
    ...
    *,
    ...
    explicitly relies on Son of Anton threading encrypted reasoning back across
                ...
                if isinstance(codex_reasoning, list):
                    for ri in codex_reasoning:
                        if isinstance(ri, dict) and ri.get("encrypted_content"):
                            ...
                            # it is a Son of Anton-side metadata key and not part
...
def _normalize_codex_response(
    ...
    *,
    ...
    if tool_calls:
        ...
        # See https://github.com/ewtodd/son-of-anton/issues/64434
