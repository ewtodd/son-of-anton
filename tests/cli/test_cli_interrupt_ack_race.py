...
Root cause: ``SonOfAntonCLI.chat()`` fires ``agent.interrupt(msg)`` from its
...
def _make_cli():
    """Build a SonOfAntonCLI with prompt_toolkit stubbed (same pattern as
