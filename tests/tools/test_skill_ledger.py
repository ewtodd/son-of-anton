...
def ledger_env(tmp_path, monkeypatch):
    """Isolated SON_OF_ANTON_HOME + skills dir for skill_manage and the ledger."""
    ...
    monkeypatch.setattr(skill_ledger, "get_son_of_anton_home", lambda: home)
    monkeypatch.setattr(skill_usage, "get_son_of_anton_home", lambda: home)
...
def test_rollback_refuses_paths_outside_son_of_anton_home(ledger_env):
    """A hand-edited ledger entry pointing outside SON_OF_ANTON_HOME must not
