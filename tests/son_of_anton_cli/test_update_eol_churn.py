"""Regression: ``son-of-anton update`` should take a managed checkout off autocrlf=true.
...
``son-of-anton update`` has to repair them.
...
from son_of_anton_cli.update_cmd import _normalize_managed_eol
