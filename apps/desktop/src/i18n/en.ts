...
export const en: Translations = {
  ...
  boot: {
    ready: 'Renco Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Renco settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Renco backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingRencoDesktop: 'Starting Renco Desktop…'
    },
    errors: {
      backgroundExited: 'Renco background process exited.',
      backgroundExitedDuringStartup: 'Renco background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Renco backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateRenco: 'Update Renco',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Renco Desktop.',
    ...
    native: {
      ...
      inputBody: 'Renco is waiting for your response.',
      turnDoneTitle: 'Renco finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Renco defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the Renco backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the Renco backend to manage this plugin from Desktop.',
      ...
      installModal: {
        ...
        agentTargetLocal: profile => `Installs into the ${profile} backend (~/.renco/plugins/)`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Renco is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Renco asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Renco was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Renco was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Renco follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Renco can react to yours.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Renco is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Renco, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      heading: 'Renco Desktop',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The Renco runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      ...
      automaticUpdatesDesc:
        'Renco checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Renco configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Renco.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Renco gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Renco Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Renco Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Renco runtime managed by this app.',
      kindRemoteDesc: 'A Renco gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Renco Cloud account.',
      kindSshDesc: 'A Renco install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Renco manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Renco Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Renco backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'Environment variables are controlling this desktop session.',
      envOverrideDesc:
        'Unset RENCO_DESKTOP_REMOTE_URL and RENCO_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Renco backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Renco backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Renco Cloud',
      cloudDesc: 'Sign in once to Renco Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Renco Cloud',
      cloudSignIn: 'Sign in to Renco Cloud',
      cloudSignedIn: 'Signed in to Renco Cloud',
      cloudNeedsSignIn: 'Sign in to Renco Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Renco Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Renco Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Renco Cloud',
      cloudSignedOutMessage: 'Cleared the Renco Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /renco.',
      ...
      restartingMessage: 'Renco Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Renco ${version}` : ''}`,
      ...
      sshDesc:
        'Renco is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshRencoPathTitle: 'Renco path (optional)',
      sshRencoPathDesc: 'Full path to the remote renco binary. Blank = auto-detect.',
      sshRencoPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Renco found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Renco runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Renco is not installed on the remote host. Install it there (curl -fsSL https://renco-agent.nousresearch.com/install.sh | sh) or set the Renco path.',
      sshErrPlatform:
        'Unsupported remote platform. Renco Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Renco on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Renco. Review the exact configuration below — it comes from the link, not from Renco.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Renco runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Renco at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via renco curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Renco builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Renco to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Renco to generate pets.',
      backgroundHint: 'You can close this — Renco will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Renco desktop' },
    ...
    rencoActiveSessions: (version, count) => `Renco ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@renco:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Renco environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Renco did not save that model change.'
    },
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Renco will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Renco backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Renco. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Renco backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Renco...',
    placeholderReconnecting: 'Reconnecting to Renco…',
    ...
    attachUrlDesc: 'Renco will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Renco to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Renco…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Renco…',
    ...
    unsupportedMessage: 'This version of Renco can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Renco from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Renco will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Renco desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Renco updater takes over in its own window and reopens Renco automatically when it’s done. Please don’t reopen Renco yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Renco reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Renco reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Renco?',
    blockerBody:
      'Renco needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Renco',
    foreignBlockerBody:
      'Renco can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Renco can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'Renco needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Renco Desktop',
    setupChoiceDesc:
      'Connect this app to a Renco gateway you already run, or install Renco locally on this computer.',
    connectExistingTitle: 'Connect to existing Renco',
    ...
    installLocalTitle: 'Install Renco locally',
    installLocalDesc: 'Download Renco, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Renco Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Renco',
    remoteSetupDesc: 'Enter your gateway URL. Renco Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Renco gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/renco',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Renco gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Renco Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Renco CLI or desktop instance is running. Stop any running Renco instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Renco Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Renco is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Renco…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Renco',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Renco at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Renco connects automatically',
    ...
    authorizeThere: 'Authorize Renco there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Renco there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Renco Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Renco Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Renco will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Renco is restarting...',
      askRestart: 'Ask Renco to restart the server',
      lookingRestart: taskId => `Renco is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Renco is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Renco to open a page.',
      finishedRestarting: message => `Renco finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Renco could not restart the server.',
      stillWorking:
        'Renco is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Renco is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Renco gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.renco/config.yaml). Renco won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Renco needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Renco needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Renco Desktop to use Save Image.',
    restartToSaveImages: 'Restart Renco Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `renco gateway` running?'
    }
  },
