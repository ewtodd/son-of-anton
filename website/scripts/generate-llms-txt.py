#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Renco docs site.
...
LLM reads to learn what Renco does.

Both publish at:
  https://renco-agent.nousresearch.com/docs/llms.txt
  https://renco-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://renco-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Renco as a Python Library", None),
        ("guides/use-mcp-with-renco", "Use MCP with Renco", None),
        ("guides/use-voice-mode-with-renco", "Use Voice Mode with Renco", None),
        ("guides/use-soul-with-renco", "Use SOUL.md with Renco", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Renco"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "renco-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/ewtodd/renco")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Renco Agent — Full Documentation\n",
        (
            "This file is the entire Renco Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Renco, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://renco-agent.nousresearch.com/docs\n",
        "Short index: https://renco-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
