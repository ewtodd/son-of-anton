...
SON_OF_ANTON_HOME with a config.yaml routing ``secrets.provider: command`` through
...
* the requested key travels ONLY via the ``SON_OF_ANTON_SECRET_KEY`` env var —
...
from son_of_anton_cli import env_loader  # noqa: E402
...
# ---------------------------------------------------------------------------
# Dispatch E2E through env_loader against a real temp SON_OF_ANTON_HOME
# ---------------------------------------------------------------------------
