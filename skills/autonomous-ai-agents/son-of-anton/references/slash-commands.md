...
Registry of record: `son_of_anton_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore Son of Anton config+state snapshots (CLI)
...
/update                  Update Son of Anton to latest
