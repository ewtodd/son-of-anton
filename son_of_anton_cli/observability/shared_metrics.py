"""Durable aggregation and local export for Son of Anton shared metrics."""
...
from son_of_anton_cli.sqlite_util import write_txn
...
_PACKAGE_SCHEMA_VERSION = "son-of-anton.shared_metrics.v2"
...
class SharedMetricsStore:
    ...
    def __init__(
        ...
        root = get_son_of_anton_home() / "telemetry" / "shared_metrics"
    ...
    def _ensure_schema(self) -> None:
        with self._connection(busy_timeout_ms=_SCHEMA_BUSY_TIMEOUT_MS) as connection:
            # Serialize first-run creation and upgrades across Son of Anton processes.
            with write_txn(connection):
    ...
    def _create_package_in_transaction(
        ...
        rows = connection.execute(
            ...
            (
                period_value,
                period_row["son_of_anton_version"],
        ...
        resource = {
            "son_of_anton_version": period_row["son_of_anton_version"],
