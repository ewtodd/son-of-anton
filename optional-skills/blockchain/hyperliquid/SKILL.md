...
```bash
python ~/.renco/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
```bash
python ~/.renco/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.renco/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
