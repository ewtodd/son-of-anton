...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (renco_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_renco_overlays():
    """renco_cli.providers.get_provider("vertex") backs
