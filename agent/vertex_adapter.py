"""Vertex AI (Google Cloud) adapter for Son of Anton Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Son of Anton to use Gemini models via Google Cloud with
...
# who installed plain `son-of-anton` and only later selected a Gemini model.
try:
