...
two endpoints so a fresh Renco install with **zero web credentials** still
...
def provider_tier(name: str) -> str:
    ...
    ``renco tools`` picker's Free/Paid rows). ``free`` forces the keyless
    ...
    try:
        ...
        return {
            ...
            "error": (
                ...
                "backend via `renco tools` for reliable service."
            ),
        }
    ...
    try:
        ...
        return {
            ...
            "error": (
                ...
                "via `renco tools` for reliable service."
            ),
        }
