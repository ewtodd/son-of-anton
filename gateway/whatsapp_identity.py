...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$RENCO_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_renco_dir("platforms/whatsapp/session", "whatsapp/session")
