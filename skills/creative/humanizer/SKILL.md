...
version: 2.5.1
author: Siqi Chen (@blader, https://github.com/blader/humanizer), ported by Son of Anton Agent
license: MIT
...
Also apply this skill to **your own** output when writing user-facing prose such as release notes, PR descriptions, docs, and summaries. Son of Anton's baseline voice already strips most of these, but a focused pass catches what slips through.

## How to use it in Son of Anton
