"""Tests for ``renco approvals suggest`` (renco_cli/approvals_suggest.py).

Approval history in Renco is implied, not ledgered: the session DB
...
from renco_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
