...
def test_status_fn_empty_selection():
    ...
    import son_of_anton_cli.tools_config as tc
    ...
    from son_of_anton_cli.tools_config import CONFIGURABLE_TOOLSETS
...
def test_curses_checklist_numbered_fallback_shows_status(monkeypatch, capsys):
    ...
    from son_of_anton_cli.curses_ui import _numbered_fallback
