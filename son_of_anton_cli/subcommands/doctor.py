"""``son-of-anton doctor`` subcommand parser.
...
def build_doctor_parser(subparsers, *, cmd_doctor: Callable) -> None:
    ...
    doctor_parser = subparsers.add_parser(
        ...
        description="Diagnose issues with Son of Anton Agent setup",
    )
    ...
    doctor_parser.add_argument(
        ...
        help=(
            ...
            "advisory will no longer trigger startup banners. Run `son-of-anton "
