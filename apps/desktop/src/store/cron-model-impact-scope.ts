...
function identityForConnection(connection: RencoConnection | null): string {
  if (!connection) {
    return ''
  }
...
export function syncCronModelImpactConnection(connection: RencoConnection | null): void {
