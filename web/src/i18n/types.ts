...
export interface Translations {
  ...
  status: {
    ...
    stopped: string;
    updateRenco: string;
    updateRencoConfirmMessage?: string;
    updateRencoConfirmNow?: string;
    updateRencoConfirmTitle?: string;
    updatingRenco: string;
  ...
  // ── Achievements plugin (plugins/renco-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;
