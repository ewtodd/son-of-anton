...
| | |
|---|---|
| Source | Optional — install with `renco skills install official/research/gitnexus-explorer` |
...
| Related skills | [`renco-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-renco-agent), [`codebase-inspection`](/docs/user-guide/skills/bundled/github/github-codebase-inspection) |
