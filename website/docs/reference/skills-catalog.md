...
| [`renco-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-renco-agent) | Use, configure, theme, extend, and orchestrate Renco Agent. | `autonomous-ai-agents/renco-agent` |
...
| [`renco-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-renco-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development/renco-agent-skill-authoring` |
| [`inspecting-renco-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-renco-desktop-dom) | Read the live Renco desktop DOM/CSS over CDP. | `software-development/inspecting-renco-desktop-dom` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Write a markdown plan to .renco/plans/; no execution. | `software-development/plan` |
