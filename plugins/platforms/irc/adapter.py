"""
IRC Platform Adapter for Son of Anton Agent.

A plugin-based gateway adapter that connects to an IRC server and relays
messages to/from the Son of Anton agent.  Zero external dependencies — uses
      ...
      platforms:
        irc:
          ...
          extra:
            ...
            port: 6697
            nickname: son-of-anton-bot
            channel: "#son-of-anton"
            use_tls: true
...
class IRCAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config, **kwargs):
        ...
        try:
            ...
            self.port = 6697
        self.nickname = os.getenv("IRC_NICKNAME") or extra.get("nickname", "son-of-anton-bot")
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        await self._send_raw(f"USER {self.nickname} 0 * :Son of Anton Agent")
    ...
    async def disconnect(self) -> None:
        ...
        if self._writer and not self._writer.is_closing():
            try:
                await self._send_raw("QUIT :Son of Anton Agent shutting down")
    ...
    async def _handle_line(self, raw: str) -> None:
        ...
        if command == "433":
            # Retry with incrementing suffix: son_of_anton_, son_of_anton_1, son_of_anton_2...
...
def check_requirements() -> bool:
    ...
    # son-of-anton setup / requirements check path.
...
def interactive_setup() -> None:
    """Interactive `son-of-anton gateway setup` flow for the IRC platform.
    ...
    print_info("Connect Son of Anton to an IRC network. Uses Python stdlib — no extra packages needed.")
    ...
    nickname = prompt(
        "Bot nickname (e.g. son-of-anton-bot)",
    ...
    channel = prompt(
        "Channel to join (e.g. #son-of-anton — comma-separate for multiple)",
    ...
    print()
    print_success("IRC configuration saved to ~/.son-of-anton/.env")
...
async def _standalone_send(
    ...
    *,
    ...
    nickname = os.getenv("IRC_NICKNAME") or extra.get("nickname", "son-of-anton-bot")
    ...
    nick_base = nickname.rstrip("_0123456789-")[:24] or "son-of-anton-bot"
    ...
    try:
        ...
        await _raw(f"USER {standalone_nick} 0 * :Son of Anton Agent (cron)")
