"""Core NeMo Relay adapter for Son of Anton tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Son of Anton tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Son of Anton Relay tool execution cannot run on an active event-loop thread"
    )
