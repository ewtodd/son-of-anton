 ...
 *
 * Symptom: in `son-of-anton --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@sonofanton/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using son-of-anton --tui and as i type multiline my caret at the end will often ' +
