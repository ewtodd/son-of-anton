...
The unit tests in tests/renco_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned renco-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/renco")
from renco_cli.service_manager import S6ServiceManager
