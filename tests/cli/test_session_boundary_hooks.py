...
from son_of_anton_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/son_of_anton_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("son_of_anton_cli.lifecycle.invoke_hook")
@patch("son_of_anton_cli.lifecycle.finalize_session")
