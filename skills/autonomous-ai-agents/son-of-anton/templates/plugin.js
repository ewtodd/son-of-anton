/**
 * Son of Anton desktop plugin template. Save as:
 *   <son-of-anton home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <son-of-anton home> is ~/.son-of-anton by default, or ~/.son-of-anton/profiles/<name>
 * when running a named profile (`son-of-anton -p <name>`). Run `son-of-anton doctor` (or
 ...
 * Only these imports resolve: @sonofanton/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@sonofanton/plugin-sdk'
