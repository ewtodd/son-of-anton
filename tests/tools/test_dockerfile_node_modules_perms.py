...
Older images made /opt/son-of-anton/ui-tui and /opt/son-of-anton/node_modules writable so a
...
def test_dockerfile_uses_prebuilt_tui_instead_of_writable_node_modules() -> None:
    ...
    assert "ENV SON_OF_ANTON_TUI_DIR=/opt/son-of-anton/ui-tui" in text
    assert "cd ../ui-tui && npm run build" in text
    assert "chown -R son-of-anton:son-of-anton /opt/son-of-anton/ui-tui" not in text
    assert "chown -R son-of-anton:son-of-anton /opt/son-of-anton/node_modules" not in text
