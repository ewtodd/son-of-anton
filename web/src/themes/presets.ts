 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `renco_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Renco Teal",
  description: "Classic dark teal — the canonical Renco look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Renco Teal (Large)",
  description: "Renco Teal with bigger fonts and roomier spacing",
