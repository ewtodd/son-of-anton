...
still running after 180.0s — restart may fail") and could deadlock `son-of-anton
...
class TestLaunchdRestartWedgedIntegration:
    ...
    def _setup(self, monkeypatch, liveness):
        events = []
        monkeypatch.setattr(gateway_cli, "get_launchd_label", lambda: "ai.son-of-anton.gateway")
