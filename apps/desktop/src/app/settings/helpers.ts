...
import type { ConfigFieldSchema, RencoConfigRecord, ToolsetInfo } from '@/types/renco'
...
export function getNested(obj: RencoConfigRecord, path: string): unknown {
  let cur: unknown = obj
 ...
 */
export function clearsEnabledToolsets(prev: RencoConfigRecord, next: RencoConfigRecord): boolean {
...
export function voiceFieldVisible(key: string, config: RencoConfigRecord): boolean {
...
export function setNested(obj: RencoConfigRecord, path: string, value: unknown): RencoConfigRecord {
...
function personalityOptions(config: RencoConfigRecord): string[] {
...
function commandProviderNames(config: RencoConfigRecord, section: 'tts' | 'stt'): string[] {
