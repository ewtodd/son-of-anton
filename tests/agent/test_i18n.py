...
def test_default_when_nothing_set(monkeypatch):
    ...
    monkeypatch.delenv("SON_OF_ANTON_LANGUAGE", raising=False)
...
def test_locales_dir_env_override_ignored_when_missing(tmp_path, monkeypatch):
    """A bogus SON_OF_ANTON_BUNDLED_LOCALES falls through to source/wheel resolution
    instead of returning a path that doesn't exist."""
    monkeypatch.setenv("SON_OF_ANTON_BUNDLED_LOCALES", str(tmp_path / "does-not-exist"))
