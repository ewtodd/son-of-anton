"""
Renco CLI - Unified command-line interface for Renco Agent.

Provides subcommands for:
- renco chat          - Interactive chat (same as ./renco)
- renco gateway       - Run gateway in foreground
- renco gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `renco setup` on a fresh Pi.
    ...
    renco_cli/stdio.py::configure_windows_stdio() runs later from the entry
