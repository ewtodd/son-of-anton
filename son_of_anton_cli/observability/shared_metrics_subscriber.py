"""Relay subscriber for the persisted Son of Anton shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Son of Anton counters from Relay lifecycle events."""

    def __init__(
        self,
        store: SharedMetricsStore,
        son_of_anton_version: str,
        *,
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Son of Anton shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
