"""``son-of-anton uninstall`` subcommand parser.
...
def build_uninstall_parser(subparsers, *, cmd_uninstall: Callable) -> None:
    ...
    uninstall_parser = subparsers.add_parser(
        "uninstall",
        help="Uninstall Son of Anton Agent",
        description="Remove Son of Anton Agent from your system. Can keep configs/data for reinstall.",
    )
