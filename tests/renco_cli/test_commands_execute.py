...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`renco_cli.slash_exec.EXECUTORS`, and
...
from renco_cli.commands import COMMAND_REGISTRY, resolve_command
from renco_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,
