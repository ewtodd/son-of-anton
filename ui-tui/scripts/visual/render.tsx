 ...
 * across theme x background scenes to <tmpdir>/son-of-anton-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@sonofanton/ink'
...
// The regenerated slate light_colors block from son_of_anton_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/son-of-anton',
...
const setup = (bgHex: string) => {
  process.env.SON_OF_ANTON_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
