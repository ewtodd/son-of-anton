...
def clear_verify_env(monkeypatch):
    ...
    set SON_OF_ANTON_SESSION_SOURCE and the gateway sets SON_OF_ANTON_SESSION_PLATFORM.
    """
    for var in (
        "SON_OF_ANTON_VERIFY_ON_STOP",
        "SON_OF_ANTON_PLATFORM",
        "SON_OF_ANTON_SESSION_PLATFORM",
        "SON_OF_ANTON_SESSION_SOURCE",
    ):
...
def test_verify_on_stop_env_can_enable(clear_verify_env):
    ...
    clear_verify_env.setenv("SON_OF_ANTON_VERIFY_ON_STOP", "1")
    clear_verify_env.setenv("SON_OF_ANTON_SESSION_PLATFORM", "telegram")
...
def test_verify_on_stop_auto_on_for_interactive_surfaces(clear_verify_env, source):
    ...
    clear_verify_env.setenv("SON_OF_ANTON_SESSION_SOURCE", source)
...
def test_verify_on_stop_default_path_through_load_config(tmp_path, clear_verify_env):
    ...
    clear_verify_env.setenv("SON_OF_ANTON_HOME", str(tmp_path / ".son-of-anton"))
    ...
    clear_verify_env.setenv("SON_OF_ANTON_SESSION_SOURCE", "cli")
...
def test_ad_hoc_pass_satisfies_no_suite_stop_loop(tmp_path, monkeypatch):
    ...
    script = Path(tempfile.gettempdir()) / f"son-of-anton-ad-hoc-stop-{tmp_path.name}.py"
