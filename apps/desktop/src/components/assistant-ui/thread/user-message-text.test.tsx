...
describe('a sent reference renders as the chip the composer showed', () => {
  it('chips a backtick-quoted @url: instead of splitting it into code', () => {
    render(
      <UserMessageText text="@url:`https://github.com/ewtodd/renco/pull/74790` urls lose formatting" />
    )

    expect(screen.queryByTitle('https://github.com/ewtodd/renco/pull/74790')).not.toBeNull()
