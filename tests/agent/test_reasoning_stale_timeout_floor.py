...
thinking phase.  Son of Anton's default cloud-stream stale detector
(``SON_OF_ANTON_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``SON_OF_ANTON_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
