...
const TAG_FULL = 'Son of Anton · Nucleus Agent'
const TAG_MID = 'Nucleus Agent'
const TAG_TINY = 'Son of Anton'
const HIDE_BELOW = 34
...
export function SessionPanel({ info, maxWidth, sid, t }: SessionPanelProps) {
  ...
  // son_of_anton_cli/banner.py) and the "connected" label on the collapse toggle.
    ...
    <Box flexDirection="column" width="100%">
      ...
      {typeof info.update_behind === 'number' && info.update_behind > 0 && (
        <Text bold color={t.color.warn}>
          ...
          <Text bold color={t.color.warn}>
            {info.update_command || 'son-of-anton update'}
          </Text>
          <Text bold={false} color={t.color.warn} dimColor>
            {' '}
            to update
