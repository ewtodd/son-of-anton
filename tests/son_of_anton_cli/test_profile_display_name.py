...
The canonical profile id ("default" for ~/.son-of-anton) is never touched —
...
def profile_env(tmp_path, monkeypatch):
    """Isolated environment: Path.home() and SON_OF_ANTON_HOME under tmp_path."""
...
class TestRenameDefault:
    ...
    def test_named_rename_still_real_and_keeps_display_name(
        ...
        monkeypatch.setattr(
            "son_of_anton_cli.profiles.check_alias_collision", lambda name: "skip"
        )
