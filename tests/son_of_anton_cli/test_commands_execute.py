...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`son_of_anton_cli.slash_exec.EXECUTORS`, and
...
from son_of_anton_cli.commands import COMMAND_REGISTRY, resolve_command
from son_of_anton_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,
