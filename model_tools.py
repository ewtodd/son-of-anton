...
def _resolve_active_context_length() -> int:
    ...
    try:
        ...
        # for SIZING the tool-search gate — unlike compaction budgeting, a
        ...
        # /models endpoint — correct for compaction sizing, but it costs a
        ...
        # resolver (called later on the compaction path) do reconciliation.
