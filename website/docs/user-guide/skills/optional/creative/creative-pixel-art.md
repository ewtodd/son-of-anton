...
| | |
|---|---|
| Source | Optional — install with `renco skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.renco/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.renco/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Renco installs package this)
