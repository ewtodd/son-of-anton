 ...
 * across theme x background scenes to <tmpdir>/renco-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@renco/ink'
...
// The regenerated slate light_colors block from renco_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/renco-agent',
...
const setup = (bgHex: string) => {
  process.env.RENCO_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
