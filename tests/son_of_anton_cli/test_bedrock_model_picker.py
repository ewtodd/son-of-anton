...
Covers the three paths changed by fix/bedrock-provider-model-ids-live-discovery:
  ...
  2. list_authenticated_providers() Section 2 (SON_OF_ANTON_OVERLAYS) — bedrock
...
# ---------------------------------------------------------------------------
# 2. list_authenticated_providers() — bedrock via SON_OF_ANTON_OVERLAYS (Section 2)
# ---------------------------------------------------------------------------
...
class TestBedrockOverlayRegistration:
    """bedrock entry in SON_OF_ANTON_OVERLAYS is correctly configured."""

    def test_bedrock_overlay_exists(self):
        from son_of_anton_cli.providers import SON_OF_ANTON_OVERLAYS
        assert "bedrock" in SON_OF_ANTON_OVERLAYS
