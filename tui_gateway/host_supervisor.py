...
def _default_registry_path() -> Path:
    return get_son_of_anton_home() / "state" / _REGISTRY_NAME
...
class HostSupervisor:
    ...
    def __init__(
        ...
        *,
        ...
        expected_son_of_anton_home: str | None = None,
        autostart: bool = True,
    ) -> None:
        ...
        self.expected_son_of_anton_home = expected_son_of_anton_home if expected_son_of_anton_home is not None else str(get_son_of_anton_home())
    ...
    def _spawn_locked(self, *, reason: str) -> None:
        ...
        if self.env:
            env.update(self.env)
        env["SON_OF_ANTON_COMPUTE_HOST_HEARTBEAT_SECS"] = str(self.heartbeat_secs)
    ...
    def _validate_hello(self) -> None:
        ...
        got_home = str(hello.get("son_of_anton_home") or "")
        if got_home and got_home != self.expected_son_of_anton_home:
            raise RuntimeError(f"compute host SON_OF_ANTON_HOME mismatch: {got_home} != {self.expected_son_of_anton_home}")
