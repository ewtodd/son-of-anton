 ...
 * startRenco() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startRenco() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startRenco`, re-emits
