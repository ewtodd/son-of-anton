...
that delegates to :func:`son_of_anton_cli.runtime_provider._resolve_azure_foundry_runtime`
...
class TestResolveProviderClientAzureFoundry:
    ...
    def test_warns_and_returns_none_on_failure(
        ...
        clear warning pointing at ``son-of-anton doctor``."""
        import logging
        ...
        assert resolved is None
        assert any(
            "azure-foundry" in rec.message and "son-of-anton doctor" in rec.message
