...
TIPS = [
    ...
    "son-of-anton chat --source discord tags the session for filtering in son-of-anton sessions list.",
    ...
    "Cron delivery targets include discord, slack, signal, and more platforms.",
