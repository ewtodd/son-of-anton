"""Tests for the interactive session browser (`renco sessions browse`).
...
from renco_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """renco sessions browse should be parseable."""
