...
const POPOUT_STORAGE_KEY = 'renco.desktop.composerPopout.zones.v1'
const POPOUT_GESTURES_ENABLED_STORAGE_KEY = 'renco.desktop.composerPopout.gesturesEnabled'
...
const LEGACY_ENABLED_KEY = 'renco.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'renco.desktop.composerPopout.position'
