...
class TestOldFilterBrokenOnWindows:
    ...
    def test_old_filter_misses_hub_on_windows_path(self):
        ...
        win_path = r"C:\Users\me\.son-of-anton\skills\.hub\quarantine\evil-skill\SKILL.md"
    ...
    def test_old_filter_works_on_unix_path(self):
        ...
        unix_path = "/home/user/.son-of-anton/skills/.hub/quarantine/evil-skill/SKILL.md"
...
class TestNewFilterCrossPlatform:
    ...
    def test_hub_quarantine_filtered(self, tmp_path):
        ...
        p = tmp_path / ".son-of-anton" / "skills" / ".hub" / "quarantine" / "evil" / "SKILL.md"
    ...
    def test_dot_prefix_not_false_positive(self, tmp_path):
        ...
        p = tmp_path / ".son-of-anton" / "skills" / ".my-hidden-skill" / "SKILL.md"
