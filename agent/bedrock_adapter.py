"""AWS Bedrock Converse API adapter for Son of Anton Agent.
...
def _require_boto3():
    ...
    try:
        ...
        raise ImportError(
            ...
            "Or install Son of Anton with Bedrock support: pip install -e '.[bedrock]'"
        )
    # converse() / converse_stream() were added in boto3 1.34.59.
    # When Son of Anton is installed editable into system Python, the system boto3
