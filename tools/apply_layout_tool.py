#!/usr/bin/env python3
"""Apply a layout preset in the Son of Anton desktop GUI.
...
_TIMEOUT_NOTE = "Layout apply is only available in the Son of Anton desktop app."
...
APPLY_LAYOUT_SCHEMA = {
    "name": "apply_layout",
    "description": (
        "Apply a saved layout preset to the Son of Anton desktop app when the user asks to "
