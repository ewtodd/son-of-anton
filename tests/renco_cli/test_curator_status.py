"""Tests for `renco curator status` output.
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated RENCO_HOME with real agent-created skills on disk."""
    home = tmp_path / ".renco"
    skills = home / "skills"
    ...
    from renco_cli import curator as curator_cli
...
def test_adopt_subcommand_is_registered():
    ...
    import renco_cli.curator as curator_cli
