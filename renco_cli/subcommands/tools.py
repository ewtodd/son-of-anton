...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'renco tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # renco tools disable <name...> [--platform cli]
    ...
    # renco tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `renco tools` runs after you pick a provider that\n"
