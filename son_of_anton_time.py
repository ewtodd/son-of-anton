"""
Timezone-aware clock for Son of Anton.
...
from son_of_anton_constants import get_config_path
...
try:
    ...
    # Python 3.8 fallback (shouldn't be needed — Son of Anton requires 3.9+)
...
def _resolve_timezone_name() -> str:
    ...
    tz_env = os.getenv("SON_OF_ANTON_TIMEZONE", "").strip()
    if tz_env:
        return tz_env
...
def reset_cache() -> None:
    ...
    config edit or ``SON_OF_ANTON_TIMEZONE`` update) to force ``get_timezone()`` /
