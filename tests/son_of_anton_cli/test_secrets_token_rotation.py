"""Tests for `son-of-anton secrets bitwarden token` / `son-of-anton secrets onepassword token`.
...
from son_of_anton_cli import onepassword_secrets_cli as op_cli
from son_of_anton_cli import secrets_cli as bw_cli
