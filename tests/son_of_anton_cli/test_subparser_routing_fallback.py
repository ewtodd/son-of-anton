...
The main() function in son_of_anton_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `son-of-anton -c model`
...
def _build_parser():
    """Build a minimal replica of the son-of-anton top-level parser."""
