"""Tests for _setup_feishu() in renco_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("renco_cli.config.save_env_value", side_effect=mock_save), \
         patch("renco_cli.config.get_env_value", side_effect=mock_get), \
         patch("renco_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("renco_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("renco_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("renco_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("renco_cli.cli_output.print_header"), \
         patch("renco_cli.cli_output.print_info"), \
         patch("renco_cli.cli_output.print_success"), \
         patch("renco_cli.cli_output.print_warning"), \
         patch("renco_cli.cli_output.print_error"), \
