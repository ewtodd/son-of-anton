...
# ``data:`` field before Renco receives a completion chunk.  Keeping this
...
#
# See: https://github.com/ewtodd/renco/issues/27344
...
# case: a stream dies mid-response and Renco persists a content-less
...
def classify_api_error(
    ...
    *,
    ...
    # renco_cli.plugins.VALID_HOOKS for the callback contract). Callback
    ...
    try:
        from renco_cli.plugins import get_plugin_error_classification
