...
export default defineConfig(({ command }) => ({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\renco\renco-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@renco/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@renco/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@renco/shared': path.resolve(__dirname, '../shared/src'),
