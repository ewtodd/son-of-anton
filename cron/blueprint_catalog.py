...
renders natively:
  ...
  * Docs catalog          -> a copy-paste command + a ``son-of-anton://`` deep-link
...
def blueprint_deeplink(blueprint: AutomationBlueprint, values: Optional[Dict[str, Any]] = None) -> str:
    """Build the ``son-of-anton://blueprint/<key>?slot=val`` deep-link URL."""
    ...
    return f"son-of-anton://blueprint/{quote(blueprint.key)}{qs}"
