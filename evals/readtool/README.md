...
benchmarked ten harnesses on hostile-file handling — and whose Renco column
...
Every task runs the full Renco agent (file + terminal + search toolsets)
...
Rules of engagement (from rencobench discipline):
