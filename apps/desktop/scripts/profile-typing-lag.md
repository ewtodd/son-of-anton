...
cd apps/desktop
XCURSOR_SIZE=24 RENCO_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/renco-typing
# → /tmp/renco-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/renco-typing.before.heapsnapshot
# → /tmp/renco-typing.after.heapsnapshot
```
