...
import type { RencoConfigRecord, SessionInfo } from '@/types/renco'
...
// / Program Files), which buried any files Renco wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.rencoDesktop` is
    ...
    const settings = window.rencoDesktop?.settings
