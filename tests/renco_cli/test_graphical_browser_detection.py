"""Tests for `_can_open_graphical_browser()` in renco_cli.auth.

Guards the fix for the May 2026 report where `renco auth add xai-oauth`
...
from renco_cli.auth import _can_open_graphical_browser
