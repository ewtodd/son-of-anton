...
# =============================================================================
# is_wsl() in son_of_anton_constants
# =============================================================================
...
class TestIsWsl:
    ...
    def setup_method(self):
        ...
        son_of_anton_constants._wsl_detected = None
    ...
    def test_detects_wsl2(self):
        ...
        with patch("builtins.open", mock_open(read_data=fake_content)):
            assert son_of_anton_constants.is_wsl() is True


    def test_no_proc_version(self):
        with patch("builtins.open", side_effect=FileNotFoundError):
            assert son_of_anton_constants.is_wsl() is False
...
class TestGatewayCommandWSLMessages:
    ...
    def test_install_wsl_no_systemd(self, monkeypatch, capsys):
        """son-of-anton gateway install on WSL without systemd shows guidance.
        ...
        assert "son-of-anton gateway run" in out
        assert "tmux" in out


    @pytest.mark.linux_only
    def test_status_wsl_running_manual(self, monkeypatch, capsys):
        """son-of-anton gateway status on WSL with manual process shows WSL note.
