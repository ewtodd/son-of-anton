 ...
 *   - RENCO AGENT wordmark rendered in Collapse Bold, uppercase, tracked
 ...
 * 99% of users; the rest will use the CLI installer with a -RencoHome
 * flag. Showing %LOCALAPPDATA% to grandma is developer-brain.
 */
export default function Welcome() {
  return (
    <div className="renco-fade-in flex h-full flex-col items-center justify-center gap-10 px-12 py-10">
      ...
      <div className="w-full max-w-2xl min-w-0 text-center">
        ...
        >
          <span>
            <span>RENCO AGENT</span>
          </span>
          <span aria-hidden="true">RENCO AGENT</span>
        </p>
