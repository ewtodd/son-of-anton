"""Shell completion script generation for son-of-anton CLI.
...
def generate_bash(parser: argparse.ArgumentParser) -> str:
    ...
    return f"""# Son of Anton Agent bash completion
# Add to ~/.bashrc:
...
complete -F _son_of_anton_completion son-of-anton
"""
...
{top_cmds_str}
            ...
            _describe 'son-of-anton command' subcmds
            ;;
        args)
            case ${{line[1]}} in
{sub_cases_str}
...
compdef _son_of_anton son-of-anton
"""
...
def generate_fish(parser: argparse.ArgumentParser) -> str:
    ...
    lines: list[str] = [
        "# Son of Anton Agent fish completion",
        "# Add to your config:",
