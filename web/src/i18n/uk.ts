...
export const uk: Translations = {
  ...
  status: {
    ...
    stopped: "Зупинено",
    updateRenco: "Оновити Renco",
    updatingRenco: "Оновлення Renco…",
  ...
  pluginsPage: {
    ...
    headline:
      "Знаходьте, встановлюйте, вмикайте та оновлюйте плагіни Renco (паритет з `renco plugins`).",
    ...
    removeConfirm: "Видалити цей плагін з ~/.renco/plugins/?",
    removeHint: "Видаляти можна лише плагіни, встановлені користувачем у ~/.renco/plugins.",
  ...
  skills: {
    ...
    filters: "Фільтри",
    noSkills: "Навичок не знайдено. Навички завантажуються з ~/.renco/skills/",
  ...
  env: {
    ...
    customHint: "Довільні змінні середовища, збережені у вашому .env, які Renco не розпізнає. Використовуйте їх для впровадження змінних середовища для навичок, серверів MCP або власних інструментів.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Колекційні значки Renco, отримані з реальної історії сеансів. Відомі, але ще не виконані досягнення показані як Виявлені; Секретні досягнення залишаються прихованими, доки не з'явиться перший відповідний сигнал.",
      scan_subtitle:
        "Сканування історії сеансів Renco. Перше сканування на великих історіях може тривати 5–10 секунд.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Останнє",
      latest_hint_empty: "запускайте Renco частіше",
      none_yet: "Поки немає",
    },
    state: {
      unlocked: "Розблоковано",
    ...
    guide: {
      ...
      secret_body:
        "Секрети приховують свій точний тригер. Щойно Renco побачить пов'язаний сигнал, картка стає Виявленою та показує свою умову.",
      scan_status_header: "Стан сканування",
      scan_status_body:
        "Renco одноразово сканує локальну історію, а потім картки з'являться автоматично. Якщо це триває кілька секунд — нічого не зависло.",
