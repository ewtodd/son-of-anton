...
class TestCreditsNoticesToggle:
    def test_disabled_emits_nothing(self):
        ...
        with patch("son_of_anton_cli.config.load_config", return_value=_cfg(False)):
    ...
    def test_toggle_cached_per_agent(self):
        ...
        with patch("son_of_anton_cli.config.load_config", return_value=_cfg(True)) as mock_load:
            agent._emit_credits_notices()
            agent._emit_credits_notices()
