...
def test_config_round_trip_uses_canonical_settings_namespace(
    ...
    ctx.set_config("api_url", r"C:\Users\Owner\Renco 🚀")
    ...
    assert settings == {
        "api_url": r"C:\Users\Owner\Renco 🚀",
        "retry": {"policy": {"attempts": 3, "enabled": True}},
    }
    assert ctx.get_config("api_url") == r"C:\Users\Owner\Renco 🚀"
...
"""
    env = dict(os.environ, RENCO_HOME=str(isolated_home))
    processes = [
        subprocess.Popen(
