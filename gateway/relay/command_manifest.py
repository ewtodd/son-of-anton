...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Son of Anton session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Son of Anton session status"},
        ...
        {"name": "update", "description": "Update Son of Anton Agent to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Son of Anton gateway"},
        {
            "name": "approve",
