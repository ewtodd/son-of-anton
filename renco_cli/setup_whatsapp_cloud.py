...
Entry point: ``renco whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``renco_cli/main.py``).
...
Renco gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Renco to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Renco needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Renco gateway in another terminal:")
    print("         renco gateway")
    print()
    ...
    print()
    print("  Docs: https://renco-agent.nousresearch.com/docs/user-guide/")
