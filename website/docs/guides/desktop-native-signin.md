...
description: "How the Renco Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the Renco Desktop app connects to a **gated gateway** (a hosted or
...
For Renco specifically, native sign-in means:
...
- [Run Renco with Nous Portal](./run-renco-with-nous-portal.md)
