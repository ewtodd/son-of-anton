...
# ``data:`` field before Son of Anton receives a completion chunk.  Keeping this
...
#
# See: https://github.com/ewtodd/son-of-anton/issues/27344
...
# case: a stream dies mid-response and Son of Anton persists a content-less
...
def classify_api_error(
    ...
    *,
    ...
    # son_of_anton_cli.plugins.VALID_HOOKS for the callback contract). Callback
    ...
    try:
        from son_of_anton_cli.plugins import get_plugin_error_classification
