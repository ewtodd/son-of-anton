/**
 * Canonical Renco skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$RENCO_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`renco_cli/skin_engine.py`),
 ...
 *   • CLI     → `renco_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
