# nix/overlays.nix — Expose pkgs.renco-agent for external NixOS configs
#
...
# `pkgs.renco-agent`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    renco-agent = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}
