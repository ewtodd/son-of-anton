import type { RencoReviewFile } from '@/global'
...
export function buildReviewFlatList(files: RencoReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: RencoReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
