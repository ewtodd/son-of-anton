#!/usr/bin/env python3
"""Leave a mark on the page in the Son of Anton desktop GUI's in-app browser.
...
def annotate_preview_tool(
    ...
    if callback is None:
        return tool_error("annotate_preview is only available in the Son of Anton desktop app.")
...
ANNOTATE_PREVIEW_SCHEMA = {
    ...
    "description": (
        ...
        "pane of the Son of Anton desktop GUI. Everything drive_preview draws as it "
