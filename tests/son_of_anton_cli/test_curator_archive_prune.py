"""Tests for `son-of-anton curator archive` and `son-of-anton curator prune`.
...
def test_archive_refuses_pinned(monkeypatch, capsys):
    import son_of_anton_cli.curator as curator_cli
    ...
    assert "son-of-anton curator unpin" in out
