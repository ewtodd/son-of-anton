...
_CA_ENV_VARS = ("SON_OF_ANTON_CA_BUNDLE", "SSL_CERT_FILE", "REQUESTS_CA_BUNDLE", "HTTPS_PROXY")
...
def test_build_keepalive_http_client_uses_son_of_anton_ca_bundle(clean_tls_env, monkeypatch):
    monkeypatch.setenv("SON_OF_ANTON_CA_BUNDLE", certifi.where())
