...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/renco'
...
// highlight markers (sqlite snippet() delimiters — see renco_state_search.py).
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('renco:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('renco:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Renco to
