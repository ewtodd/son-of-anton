import { Box, type ScrollBoxHandle, stringWidth, Text } from '@renco/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (RENCO_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (RENCO_DEV_CREDITS), lowest priority,
