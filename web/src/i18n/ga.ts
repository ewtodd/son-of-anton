...
export const ga: Translations = {
  ...
  status: {
    ...
    stopped: "Stoptha",
    updateRenco: "Nuashonraigh Renco",
    updatingRenco: "Ag nuashonrú Renco…",
  ...
  pluginsPage: {
    ...
    headline:
      "Faigh, suiteáil, cumasaigh agus nuashonraigh plugins Renco (paireacht le `renco plugins`).",
    ...
    removeConfirm: "Bain an plugin seo ó ~/.renco/plugins/?",
    removeHint: "Ní féidir ach plugins atá suiteáilte ag an úsáideoir faoi ~/.renco/plugins a bhaint.",
  ...
  skills: {
    ...
    filters: "Scagairí",
    noSkills: "Níor aimsíodh scileanna. Luchtaítear scileanna ó ~/.renco/skills/",
  ...
  env: {
    ...
    customHint: "Athróga timpeallachta treallach atá stóráilte i do .env nach n-aithníonn Renco. Úsáid iad chun athróga timpeallachta a instealladh do scileanna, freastalaithe MCP, nó d'uirlisí féin.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Suaitheantais Renco inbhailithe a thuilltear ó stair fíor-session. Léirítear gnóthachtálacha aitheanta neamhchríochnaithe mar Discovered; fanann gnóthachtálacha Secret i bhfolach go dtí go bhfeictear an chéad iompar comhoiriúnach.",
      scan_subtitle:
        "Stair session Renco á scanadh. Is féidir leis an gcéad scan 5–10 soicind a thógáil ar staireanna móra.",
    },
    actions: {
      rescan: "Athscan",
    },
    stats: {
      ...
      latest_hint_empty: "rith Renco níos mó",
    ...
    guide: {
      ...
      secret_body:
        "Coinníonn rúin a dtruicear cruinn faoi cheilt. Nuair a fheiceann Renco comhartha gaolmhar, athraíonn an cárta go Aimsithe agus taispeánann sé a riachtanas.",
      scan_status_header: "Stádas an scanta",
      scan_status_body:
        "Scanann Renco an stair logánta uair amháin, ansin feicfear cártaí go huathoibríoch. Níl aon rud sáinnithe má thógann sé cúpla soicind.",
