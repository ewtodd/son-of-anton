"""Tests for son_of_anton_cli.gitlock — stale git lock recovery + ancestry probe.
...
from son_of_anton_cli.gitlock import (
    LOCK_NAMES,
...
def no_git_running(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    """
    import son_of_anton_cli.gitlock as gitlock
