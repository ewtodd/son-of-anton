"""The `renco-agent` skill is what a running Renco knows about itself.

`website/` is never packaged, so an installed Renco has no local copy of the
user guide; skills ARE synced into `$RENCO_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "Renco can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "renco-agent"
