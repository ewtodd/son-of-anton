...
the join never returns.  ``son-of-anton update`` wedged exactly there inside
...
from son_of_anton_cli._subprocess_compat import bounded_git_probe, bounded_probe_run
