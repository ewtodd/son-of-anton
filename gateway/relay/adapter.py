...
class RelayAdapter(BasePlatformAdapter):
    ...
    def _relay_slack_extra(self) -> Dict[str, Any]:
        ...
        Enterprise knob shape (Son of Anton-config directed, relay-namespaced):
        ...
        try:
            ...
            if platform == "discord":
                ...
                if event is not None:
                    self._capture_scope(event)
                    # Phase 3: a component press carrying a Son of Anton prompt token
    ...
    def _discord_interaction_to_event(self, forward):
        ...
        if itype == 3:
            # Phase 3: a component press whose custom_id is a Son of Anton prompt
    ...
    def _decode_prompt_token(token: str):
        ...
        — and is not — a Son of Anton prompt answer.
        """
        import re
    ...
    def _resolve_reply_to_for_send(
        ...
        Native Slack Son of Anton already suppresses this synthetic DM thread anchor:
    ...
    async def _send_prompt(
        ...
        *,
        ...
        # Son of Anton suppresses this synthetic DM thread anchor; drop it here for the
