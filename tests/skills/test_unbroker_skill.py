...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and son-of-anton
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # son-of-anton (tests/skills/)
]
