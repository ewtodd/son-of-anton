...
Registry of record: `renco_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore Renco config+state snapshots (CLI)
