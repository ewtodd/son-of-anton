...
``$SON_OF_ANTON_HOME/plugins/``, runs ``PluginManager().discover_and_load()``,
...
class TestRegisterTranscriptionProvider:
    def test_accepts_valid_provider(self):
        ...
        _enable(son_of_anton_home, "my-stt-plugin")
    ...
    def test_rejects_non_provider(self, caplog):
        ...
        _enable(son_of_anton_home, "bad-stt-plugin")
    ...
    def test_rejects_builtin_shadow(self, caplog):
        ...
        _enable(son_of_anton_home, "shadow-stt-plugin")
