...
two endpoints so a fresh Son of Anton install with **zero web credentials** still
    ...
    try:
        ...
        return {
            ...
            "error": (
                ...
                "backend via `son-of-anton tools` for reliable service."
            ),
        }
    ...
    try:
        ...
        return {
            ...
            "error": (
                ...
                "via `son-of-anton tools` for reliable service."
            ),
        }
