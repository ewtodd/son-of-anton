...
import type { ProjectInfo, SessionInfo } from '@/renco'
 ...
 * repo shows its branches/worktrees even when they have no Renco sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: RencoGitWorktree[]
): SidebarSessionGroup[] {
