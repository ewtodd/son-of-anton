"""Tests for the specifier module + `renco kanban specify` CLI surface.
...
from renco_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `renco kanban …` argparse surface directly."""
