...
Renco is exactly the topology this hits: gateway, dispatcher, dashboard,
...
class _TrackingMixin:
    ...
    _renco_tracked_path: str | None = None

    def close(self) -> None:  # type: ignore[misc]
        with _live_lock:
            path = getattr(self, "_renco_tracked_path", None)
    ...
    **kwargs,
    ...
    with _live_lock:
        ...
        try:
            ...
            conn._renco_tracked_path = resolved
