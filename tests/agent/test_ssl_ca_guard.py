...
def test_healthy_bundle_passes(monkeypatch):
    ...
    for key in ("SON_OF_ANTON_CA_BUNDLE", "SSL_CERT_FILE", "REQUESTS_CA_BUNDLE", "CURL_CA_BUNDLE"):
...
@pytest.mark.parametrize("env_var", ["SON_OF_ANTON_CA_BUNDLE", "SSL_CERT_FILE", "REQUESTS_CA_BUNDLE", "CURL_CA_BUNDLE"])
