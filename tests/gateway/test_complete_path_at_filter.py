...
def _reset_fuzzy_cache(monkeypatch):
    ...
    # via _load_cfg(), which resolves through _son_of_anton_home captured at module
    # import time — before the per-test SON_OF_ANTON_HOME redirect applies. When the
