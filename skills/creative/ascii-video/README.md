...
Built for [Renco Agent](https://github.com/ewtodd/renco). Usable in any coding agent. Canonical source lives here; synced to [`ewtodd/renco/skills/creative/ascii-video`](https://github.com/ewtodd/renco/tree/main/skills/creative/ascii-video) via PR.
