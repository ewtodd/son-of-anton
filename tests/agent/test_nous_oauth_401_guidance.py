...
to a generic "Your API key was rejected... run son-of-anton setup" message, which is
...
def test_nous_401_guidance_strings_present():
    ...
    # Must give a concrete re-auth command, not a generic "son-of-anton setup".
    assert "son-of-anton portal" in source
