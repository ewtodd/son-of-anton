...
Configuration
-------------
Secret (lives in $RENCO_HOME/.env or the environment):
...
Behavioral settings (live in $RENCO_HOME/mem0.json, set via `renco memory
setup`):
  ...
  agent_id           — Agent identifier (default: renco)
...
def _load_config() -> dict:
    """Load config from env vars, with $RENCO_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "renco"),
        "oss": {},
    }
    ...
    config_path = get_renco_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, renco_home):
        """Write config to $RENCO_HOME/mem0.json."""
        import json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $RENCO_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "renco")
