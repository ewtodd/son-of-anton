/**
 * Canonical Son of Anton skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$SON_OF_ANTON_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`son_of_anton_cli/skin_engine.py`),
 ...
 *   • CLI     → `son_of_anton_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
...
export interface SonOfAntonSkin {
  name?: string
  description?: string
  colors?: SkinColors
