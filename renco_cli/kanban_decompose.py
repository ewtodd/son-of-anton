...
Invoked by ``renco kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Renco Agent board.
...
def _profile_author() -> str:
    """Mirror of ``renco_cli.kanban._profile_author``."""
    return (
