...
import type { SessionMessage } from '@/types/renco'
...
describe('toChatMessages', () => {
  ...
  it('renders MEDIA tags as assistant attachment links', () => {
    const [message] = toChatMessages([
      {
        role: 'assistant',
        content: "MEDIA:/Users/brooklyn/.renco/cache/audio/tts_20260501_222725.mp3\n\nhow's that sound?",
        timestamp: 1
      }
    ])

    expect(chatMessageText(message)).toBe(
      "[Audio: tts_20260501_222725.mp3](#media:%2FUsers%2Fbrooklyn%2F.renco%2Fcache%2Faudio%2Ftts_20260501_222725.mp3)\n\nhow's that sound?"
    )
  })
  ...
  it('renders a native-vision turn as caption plus thumbnail, not raw placeholder text', () => {
    ...
    const ref = '@image:`/Users/me/Library/Application Support/Renco/composer-images/a.png`'
