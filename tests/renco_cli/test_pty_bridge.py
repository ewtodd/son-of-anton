"""Unit tests for renco_cli.pty_bridge — PTY spawning + byte forwarding.
...
class TestClampDimension:
    def test_clamps_above_max(self):
        from renco_cli.pty_bridge import _MAX_COLS, _MAX_ROWS, _clamp_dimension
    ...
    def test_non_numeric_falls_back_to_min(self):
        from renco_cli.pty_bridge import _MAX_COLS, _clamp_dimension
