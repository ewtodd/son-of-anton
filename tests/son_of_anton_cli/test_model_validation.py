"""Tests for provider-aware `/model` validation in son_of_anton_cli.models."""
...
def _validate(model, provider="openrouter", api_models=FAKE_API_MODELS, **kw):
    ...
    with patch("son_of_anton_cli.models.fetch_api_models", return_value=api_models), \
...
class TestFetchApiModels:
    ...
    def test_probe_api_models_tries_v1_fallback(self):
        ...
        with patch("son_of_anton_cli.models._urlopen_model_catalog_request", side_effect=_fake_urlopen):
    ...
    def test_probe_api_models_uses_copilot_catalog(self):
        ...
        with patch("son_of_anton_cli.models._urlopen_model_catalog_request", return_value=_Resp()) as mock_urlopen:
...
class TestValidateApiFallback:
    ...
    def test_fetch_lmstudio_models_filters_embedding_type(self):
        ...
        with patch("son_of_anton_cli.models._urlopen_model_catalog_request", return_value=mock_resp):
    ...
    def test_validate_lmstudio_distinguishes_auth_failure(self):
        ...
        with patch("son_of_anton_cli.models._urlopen_model_catalog_request", side_effect=http_error):
...
class TestValidateCodexAutoCorrection:
    ...
    def test_missing_dash_auto_corrects(self):
        ...
        with patch("son_of_anton_cli.models.provider_model_ids", return_value=codex_models):
...
class TestProbeApiModelsUserAgent:
    """Probing custom /v1/models must send a Son of Anton User-Agent.
    ...
    def test_probe_sends_son_of_anton_user_agent(self):
        ...
        assert ua.startswith("son-of-anton-cli/"), (
            f"User-Agent must advertise son-of-anton-cli, got {ua!r}"
        )
    ...
    def test_probe_user_agent_sent_without_api_key(self):
        ...
        assert ua and ua.startswith("son-of-anton-cli/")
