...
import type { ModelOptionsResponse, SessionInfo } from '@/types/renco'
 ...
 *
 * Only the leading status prefix (e.g. "Renco is thinking...") and the
 ...
 *  resolved comment as JSON (RencoPrComment shape); a malformed payload falls
