...
async def test_start_gateway_verbosity_imports_redacting_formatter(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("son_of_anton_logging.setup_logging", lambda son_of_anton_home, mode: tmp_path)
    monkeypatch.setattr("son_of_anton_logging._add_rotating_handler", lambda *args, **kwargs: None)
