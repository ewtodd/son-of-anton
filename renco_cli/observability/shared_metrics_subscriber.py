"""Relay subscriber for the persisted Renco shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Renco counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Renco shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
