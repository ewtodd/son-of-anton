...
async def test_run_agent_binds_api_session_context_for_tool_env(adapter, monkeypatch):
    ...
    monkeypatch.setenv("SON_OF_ANTON_SESSION_ID", "stale-session")
    observed = {}
    ...
    class FakeAgent:
        ...
        def run_conversation(self, user_message, conversation_history, task_id):
            ...
            observed["context_session_id"] = get_session_env("SON_OF_ANTON_SESSION_ID")
            observed["context_platform"] = get_session_env("SON_OF_ANTON_SESSION_PLATFORM")
            observed["context_session_key"] = get_session_env("SON_OF_ANTON_SESSION_KEY")
            observed["child_session_id"] = _make_run_env({}).get("SON_OF_ANTON_SESSION_ID")
...
async def test_session_chat_treats_pre_existing_poisoned_row_as_no_model(session_db):
    ...
    virtual model alias (e.g. "son-of-anton") persisted literally as its
...
async def test_run_agent_reports_actual_agent_runtime_not_requested_metadata(adapter, monkeypatch):
    class FakeAgent:
        ...
        def __init__(self):
            ...
            self._son_of_anton_api_runtime = {
