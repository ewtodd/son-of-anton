...
class SonOfAntonCLI(CLIAgentSetupMixin, CLICommandsMixin):
    ...
    def run(self):
        ...
        self._tui_style_base = {
            ...
            'input-area': '',
            'placeholder': 'default italic',
            'prompt': '',
            'prompt-working': 'default italic',
            'hint': 'default italic',
            'status-bar': 'bg:default default',
            'status-bar-strong': 'bg:default bold yellow',
            'status-bar-dim': 'bg:default default',
            'status-bar-good': 'bg:default bold green',
            'status-bar-warn': 'bg:default bold yellow',
            ...
            'approval-cmd': 'ansibrightblack italic',
            'approval-choice': 'ansibrightblack',
