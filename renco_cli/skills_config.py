"""
Skills configuration for Renco Agent.
`renco skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.renco/config.yaml under:
...
from renco_cli.config import cfg_get, load_config, save_config
from renco_cli.colors import Colors, color
from renco_cli.platforms import PLATFORMS as _PLATFORMS
