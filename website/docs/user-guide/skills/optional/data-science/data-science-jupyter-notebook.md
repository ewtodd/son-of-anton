...
| | |
|---|---|
| Source | Optional — install with `renco skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing renco tool access (web_search, file ops). Stateless. |
