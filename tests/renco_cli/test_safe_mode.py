"""Tests for `renco chat --safe-mode` isolation."""
...
_VARS = ("RENCO_SAFE_MODE", "RENCO_IGNORE_USER_CONFIG", "RENCO_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["RENCO_SAFE_MODE"] == "1"
        assert os.environ["RENCO_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["RENCO_IGNORE_RULES"] == "1"
        return True
