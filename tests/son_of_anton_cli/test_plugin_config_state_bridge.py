...
def test_config_round_trip_uses_canonical_settings_namespace(
    ...
    ctx.set_config("api_url", r"C:\Users\Owner\Son of Anton 🚀")
    ...
    assert settings == {
        "api_url": r"C:\Users\Owner\Son of Anton 🚀",
        "retry": {"policy": {"attempts": 3, "enabled": True}},
    }
    assert ctx.get_config("api_url") == r"C:\Users\Owner\Son of Anton 🚀"
...
"""
    env = dict(os.environ, SON_OF_ANTON_HOME=str(isolated_home))
    processes = [
        subprocess.Popen(
