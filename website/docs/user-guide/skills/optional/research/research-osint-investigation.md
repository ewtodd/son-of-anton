...
| | |
|---|---|
| Source | Optional — install with `renco skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Renco Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
| License | MIT |
...
# $RENCO_OSINT_CACHE/icij/ (default: ~/.cache/renco-osint/icij/).
...
# Set RENCO_OSINT_UA=your-app/1.0 (your@email) to identify yourself
