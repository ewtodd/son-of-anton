...
import type { ModelOptionProvider, OAuthProvider } from '@/types/renco'
...
const API_KEY_OPTIONS: ApiKeyOption[] = [
  ...
  },
  {
    ...
    docsUrl: 'https://github.com/ewtodd/renco#bring-your-own-endpoint',
    placeholder: 'http://127.0.0.1:8000/v1'
  }
]

// Build the FULL API-key provider catalog from the backend model options so the
// onboarding / Providers key form lists every `api_key` provider `renco model`
...
const SHOW_ALL_KEY = 'renco-onboarding-show-all-v1'
