...
def _profile_scoped(handler):
    ...
    Projects (projects.db, discovery policy) and other home-resolved state
...
# check interval keeps the pricier probes off the 0.5s tick.
...
def _ensure_skin_watcher() -> None:
    ...
    change, a session state change, a cron the scheduler fires, or a
