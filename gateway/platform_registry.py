...
class PlatformEntry:
    ...
    # status displays (``son-of-anton setup``, ``son-of-anton status``, the dashboard
    ...
    # Env vars this platform needs (for ``son-of-anton setup`` display).
    ...
    # built-ins).  Used by ``son-of-anton gateway setup`` to auto-enable the
    ...
    # hard-casing in Son of Anton core.
    #
    # Signature:
...
class PlatformRegistry:
    ...
    def __init__(self) -> None:
        ...
        # Plugin adapters are isolated per resolved SON_OF_ANTON_HOME and overlay the
        ...
        # `son-of-anton setup`/`gateway status`, send_message).
    ...
    def _resolve_all(self) -> None:
        ...
        gateway startup, ``son-of-anton setup``/``gateway status``, channel
