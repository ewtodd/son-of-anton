"""``son-of-anton tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    # son-of-anton tools list [--platform cli]
    ...
    # son-of-anton tools disable <name...> [--platform cli]
    ...
    # son-of-anton tools enable <name...> [--platform cli]
    ...
    # son-of-anton tools post-setup <key>
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `son-of-anton tools` runs after you pick a provider that\n"
