"""Tests for ``renco peer`` — cross-machine bot-to-bot DMs."""
...
from renco_cli.subcommands import peer as peer_cmd
...
class _FakePeer(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        if self.path == "/api/sessions":
            ...
            return self._json({"object": "renco.session", "session": {"id": "bc_1", "title": body.get("title")}}, 201)
