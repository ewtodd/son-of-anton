...
export interface PetInfo {
  ...
  // the Renco "run" activity state uses the in-place running row).
 ...
 * RENCO_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'renco.desktop.pet-roam.v1'
