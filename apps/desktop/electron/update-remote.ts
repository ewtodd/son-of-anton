 ...
 *
 * A public install can end up with `origin=git@github.com:ewtodd/renco.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/ewtodd/renco.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/nousresearch/renco-agent'
