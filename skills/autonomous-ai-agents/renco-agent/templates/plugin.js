/**
 * Renco desktop plugin template. Save as:
 *   <renco home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <renco home> is ~/.renco by default, or ~/.renco/profiles/<name>
 * when running a named profile (`renco -p <name>`). Run `renco doctor` (or
 ...
 * Only these imports resolve: @renco/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@renco/plugin-sdk'
