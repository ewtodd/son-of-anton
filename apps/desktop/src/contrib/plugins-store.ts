 ...
 * `<renco home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'renco.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'renco.desktop.disabledPlugins.v1'
