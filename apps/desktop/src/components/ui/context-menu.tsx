...
export const RENCO_CONTEXT_MENU_TRIGGER_ATTR = 'data-renco-context-menu-trigger'

function ContextMenuTrigger({ ...props }: React.ComponentProps<typeof ContextMenuPrimitive.Trigger>) {
  return (
    <ContextMenuPrimitive.Trigger data-slot="context-menu-trigger" {...props} data-renco-context-menu-trigger="" />
  )
}
