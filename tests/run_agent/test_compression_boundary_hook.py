...
old_session_id=<old>). This lets plugin engines (e.g. son-of-anton-lcm) preserve
DAG lineage across the split instead of treating it as a fresh /new.

See son-of-anton-lcm#68: after Son of Anton compresses and mints a new physical session,
