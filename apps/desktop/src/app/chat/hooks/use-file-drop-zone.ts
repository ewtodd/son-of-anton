...
import { type DroppedFile, extractDroppedFiles, RENCO_PATHS_MIME } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, RENCO_PATHS_MIME) ? 'files' : null
