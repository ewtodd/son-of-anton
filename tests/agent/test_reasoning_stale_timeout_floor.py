...
thinking phase.  Renco's default cloud-stream stale detector
(``RENCO_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``RENCO_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
