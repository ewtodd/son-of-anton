"""``son-of-anton gateway`` and ``son-of-anton proxy`` subcommand parsers.
...
def build_gateway_parser(
    ...
    gateway_migrate_legacy = gateway_subparsers.add_parser(
        "migrate-legacy",
        help="Remove legacy son-of-anton.service units from pre-rename installs",
        description=(
            "Stop, disable, and remove legacy Son of Anton gateway unit files "
            "(e.g. son-of-anton.service) left over from older installs. Profile "
            "units (son-of-anton-gateway-<profile>.service) and unrelated "
    ...
    gateway_enroll = gateway_subparsers.add_parser(
        ...
        description=(
            ...
            "GATEWAY_RELAY_SECRET / GATEWAY_RELAY_DELIVERY_KEY into ~/.son-of-anton/.env. "
            "Requires being logged in (son-of-anton setup). Not available in managed installs."
        ),
    )
    ...
    gateway_enroll.add_argument(
        ...
        help=(
            ...
            "GATEWAY_RELAY_WAKE_URL in ~/.son-of-anton/.env and forwarded at provision. "
    ...
    proxy_start.add_argument(
        "--provider",
        default="nous",
        help="Upstream provider: nous or xai (default: nous). See `son-of-anton proxy providers`.",
    )
    proxy_start.add_argument(
        "--host",
        default=None,
