...
EVIDENCE_START = "<!-- renco-e2e-evidence:start -->"
EVIDENCE_END = "<!-- renco-e2e-evidence:end -->"
...
def _api_request(
    ...
    request = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "renco-e2e-evidence-publisher",
        },
    )
...
def _find_review_comment(comments: object) -> dict[str, Any] | None:
    ...
    for item in comments:
        ...
        if body.startswith("<!-- renco-ci-review-bot -->") and EVIDENCE_START in body and EVIDENCE_END in body:
            return item
    return None
