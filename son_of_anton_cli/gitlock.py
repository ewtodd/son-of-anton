...
This wedges ``son-of-anton update --check`` (hard failure) and silently degrades the
passive banner check in :mod:`son_of_anton_cli.banner` (the fetch is swallowed, the
