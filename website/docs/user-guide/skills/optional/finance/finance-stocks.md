...
| | |
|---|---|
| Source | Optional — install with `renco skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Renco Agent |
| License | MIT |
...
```
SCRIPT=~/.renco/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.renco/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
