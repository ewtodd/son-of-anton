"""``son-of-anton slack`` subcommand parser.
...
def build_slack_parser(subparsers, *, cmd_slack: Callable) -> None:
    ...
    slack_parser = subparsers.add_parser(
        ...
        description="Slack integration helpers for Son of Anton.",
    )
    ...
    slack_manifest.add_argument(
        ...
        "writes to $SON_OF_ANTON_HOME/slack-manifest.json.",
    )
    slack_manifest.add_argument(
        "--name",
        default=None,
        help='Bot display name (default: "Son of Anton")',
    )
    slack_manifest.add_argument(
        "--description",
        default=None,
