...
(3 SDK retries x 3 Renco retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = os.path.join(os.path.expanduser("~"), ".renco")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Renco, ...) behind one endpoint.  A 429 can mean either:
