...
# When the user hasn't picked a reasoning effort, Renco passes
...
# ON at this effort — matching the "medium (default)" that Renco' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Renco' effort vocabulary onto Solar's accepted set via the
