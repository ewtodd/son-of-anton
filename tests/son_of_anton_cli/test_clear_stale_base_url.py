...
from son_of_anton_cli.config import load_config, save_config, save_env_value, get_env_value
...
class TestClearStaleOpenaiBaseUrl:
    ...
    def test_clears_when_provider_is_named(self, monkeypatch):
        ...
        from son_of_anton_cli.main import _clear_stale_openai_base_url
