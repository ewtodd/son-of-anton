 ...
 *
 * Values mirror renco_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Renco default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Renco' default when unset). */
