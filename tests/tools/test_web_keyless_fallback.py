...
# ---------------------------------------------------------------------------
# son-of-anton tools picker: tier variant rows
# ---------------------------------------------------------------------------
...
class TestPickerTierRows:
    def test_variant_schemas_flatten_to_tier_rows(self, fresh_registry, monkeypatch):
        ...
        monkeypatch.setattr(
            "son_of_anton_cli.plugins._ensure_plugins_discovered", lambda: None
        )
    ...
    def test_selection_persists_tier(self):
        from son_of_anton_cli.tools_config import _write_provider_config
    ...
    def test_tier_match_highlights_correct_row(self):
        from son_of_anton_cli.tools_config import _web_tier_matches
