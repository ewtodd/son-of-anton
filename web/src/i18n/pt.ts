...
export const pt: Translations = {
  ...
  status: {
    ...
    stopped: "Parado",
    updateRenco: "Atualizar Renco",
    updatingRenco: "A atualizar Renco…",
  ...
  pluginsPage: {
    ...
    headline:
      "Descobrir, instalar, ativar e atualizar plugins Renco (paridade com `renco plugins`).",
    ...
    removeConfirm: "Remover este plugin de ~/.renco/plugins/?",
    removeHint: "Apenas plugins instalados pelo utilizador em ~/.renco/plugins podem ser removidos.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "Nenhuma competência encontrada. As competências são carregadas de ~/.renco/skills/",
  ...
  env: {
    ...
    customHint: "Variáveis de ambiente arbitrárias armazenadas no seu .env que o Renco não reconhece. Use-as para injetar variáveis de ambiente para skills, servidores MCP ou suas próprias ferramentas.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Distintivos colecionáveis do Renco obtidos a partir do histórico real de sessões. Conquistas conhecidas mas ainda não obtidas aparecem como Descobertas; conquistas Secretas permanecem ocultas até surgir o primeiro comportamento correspondente.",
      scan_subtitle:
        "A analisar o histórico de sessões do Renco. A primeira análise pode demorar 5–10 segundos em históricos extensos.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Mais recente",
      latest_hint_empty: "execute mais o Renco",
    ...
    guide: {
      ...
      secret_body:
        "As secretas escondem o seu acionador exato. Assim que o Renco detetar um sinal relacionado, o cartão passa a Descoberta e mostra o requisito.",
      scan_status_header: "Estado da análise",
      scan_status_body:
        "O Renco analisa o histórico local uma vez e depois os cartões aparecem automaticamente. Nada está bloqueado se isto demorar alguns segundos.",
