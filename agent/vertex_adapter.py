"""Vertex AI (Google Cloud) adapter for Renco Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Renco to use Gemini models via Google Cloud with
...
# who installed plain `renco-agent` and only later selected a Gemini model.
try:
