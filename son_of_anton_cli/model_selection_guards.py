...
Son of Anton has multiple model-selection surfaces (CLI picker, TUI, dashboard,
gateway ``/model``, Discord pickers, TUI-gateway RPC). Each of them
...
def _cost_guard(
    ...
    from son_of_anton_cli.model_cost_guard import expensive_model_warning
...
def _data_policy_guard(
    ...
    from son_of_anton_cli.model_data_policy_guard import data_training_warning
