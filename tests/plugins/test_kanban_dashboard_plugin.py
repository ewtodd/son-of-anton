...
def _load_plugin_router():
    ...
    spec = importlib.util.spec_from_file_location(
        "renco_dashboard_plugin_kanban_test", plugin_file,
    )
...
def test_ws_events_rejects_when_token_required(tmp_path, monkeypatch):
    ...
    monkeypatch.setitem(sys.modules, "renco_cli.web_server", stub)
    monkeypatch.setattr(renco_cli, "web_server", stub, raising=False)
...
# tests/renco_cli/test_kanban_db.py. The OUTER fallback here is not, which
