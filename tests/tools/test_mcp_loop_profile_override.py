"""Regression tests for SON_OF_ANTON_HOME override propagation onto the MCP loop.
...
get_son_of_anton_home() inside the coroutine, most visibly OAuth token-store
