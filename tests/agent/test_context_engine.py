...
class TestPluginContextEngineSlot:
    ...
    def test_register_engine(self):
        from son_of_anton_cli.plugins import PluginManager, PluginContext, PluginManifest
        mgr = PluginManager()
    ...
    def test_get_plugin_context_engine(self):
        from son_of_anton_cli.plugins import PluginManager, get_plugin_context_engine
