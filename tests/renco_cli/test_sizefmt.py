"""Tests for the shared byte formatter (renco_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from renco_cli.backup import _format_size as backup
    from renco_cli.checkpoints import _fmt_bytes as checkpoints
    from renco_cli.doctor import _human_bytes as doctor
