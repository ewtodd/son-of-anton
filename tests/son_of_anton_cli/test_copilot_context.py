...
class TestGetCopilotModelContext:
    ...
    @patch("son_of_anton_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("son_of_anton_cli.models._urlopen_model_catalog_request")
    ...
    @patch("son_of_anton_cli.models.fetch_github_model_catalog", return_value=[])
