...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `renco_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `renco_cli/` | [Extending the CLI](extending-the-cli.md) |
| Plugins system | `plugins/` | [Build a Renco Plugin](plugins/index.md) |
...
| Session storage | `renco_state.py` | [Session Storage](session-storage.md) |
