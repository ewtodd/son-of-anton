...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Renco session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Renco session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Renco agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Renco Agent to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Renco gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Renco session in it",
