#!/usr/bin/env python3
"""
SWE Runner with Renco Trajectory Format

A runner that uses Renco-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Renco-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Renco-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Renco format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Renco-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Renco-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Renco Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Renco-Agent's built-in execution environments
    and outputs trajectories in Renco-Agent format.
    """
    ...
    def _convert_to_renco_format(
        ...
        """
        Convert internal message format to Renco trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Renco trajectory format
        trajectory = self._convert_to_renco_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Renco trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Renco Trajectory Format")
    print("=" * 60)
