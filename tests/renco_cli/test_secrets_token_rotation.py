"""Tests for `renco secrets bitwarden token` / `renco secrets onepassword token`.
...
from renco_cli import onepassword_secrets_cli as op_cli
from renco_cli import secrets_cli as bw_cli
