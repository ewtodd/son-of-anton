...
await build({
  ...
  // Skip the prebuilt @renco/ink bundle and inline the source instead:
  ...
  alias: { '@renco/ink': resolve(root, 'packages/renco-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The renco_cli launcher
