...
the get_anchored_view / get_messages_around primitives in son_of_anton_state.
...
from son_of_anton_state_common import _RESET_END_REASONS

# Sources that are excluded from session browsing/searching by default.
# Third-party integrations tag their sessions with SON_OF_ANTON_SESSION_SOURCE=tool;
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from son_of_anton_state import _default_db_path
...
SESSION_SEARCH_SCHEMA = {
    ...
    "description": (
        ...
        "SOURCE-FIRST LIMIT\n\n"
        "  This tool searches Son of Anton conversation history only. It is not evidence "
        ...
        "reformat it as a markdown link or wrap it in backticks. Son of Anton renders "
        ...
        "(`deploy*`).\n\n"
        "WHEN TO USE\n\n"
        "  Reach for this on questions about Son of Anton conversation history itself, such "
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another Son of Anton profile's database "
