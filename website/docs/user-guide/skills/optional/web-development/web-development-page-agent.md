...
| | |
|---|---|
| Source | Optional — install with `renco skills install official/web-development/page-agent` |
...
- User wants **Renco itself to drive a browser** → use Renco' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
