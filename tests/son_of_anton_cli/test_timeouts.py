...
def test_resolved_api_call_timeout_priority(monkeypatch, tmp_path):
          ...
          openrouter:
            ...
            models:
              openai/gpt-4o-mini:
                timeout_seconds: 42
        """)
    monkeypatch.setenv("SON_OF_ANTON_API_TIMEOUT", "999")
    ...
    from son_of_anton_cli import timeouts as to_mod
    ...
    monkeypatch.delenv("SON_OF_ANTON_API_TIMEOUT", raising=False)
