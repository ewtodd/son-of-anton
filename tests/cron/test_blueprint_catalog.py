...
the shared /blueprint command handler (son_of_anton_cli/blueprint_cmd.py), and
the docs generator. Uses an isolated SON_OF_ANTON_HOME for anything that touches the
cron job store.
"""
...
class TestRenderers:
    ...
    def test_deeplink_shape(self):
        ...
        assert url.startswith("son-of-anton://blueprint/morning-brief?")
