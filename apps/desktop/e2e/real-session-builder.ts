 ...
 * AIAgent loop, using the E2E mock provider configured in `rencoHome`.
 *
...
export class RealSessionBuilder {
  ...
  private constructor(rencoHome: string) {
  ...
  static async start(rencoHome: string): Promise<RealSessionBuilder> {
    const builder = new RealSessionBuilder(rencoHome)
