...
| | |
|---|---|
| Source | Optional — install with `renco skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Renco Agent |
| License | MIT |
...
The script reads `${RENCO_HOME:-~/.renco}/.env` for two optional defaults:
...
Helper script: `~/.renco/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.renco/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${RENCO_HOME:-~/.renco}/.env`.
...
```bash
python3 ~/.renco/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.renco/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
