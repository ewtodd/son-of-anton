...
per child under::
    ...
    <son_of_anton_home>/cache/delegation/live/<delegation_id>/task-<n>.log
...
def live_transcript_root() -> Path:
    """Root directory for live transcripts (profile-safe, never ~/.son-of-anton)."""
    from son_of_anton_constants import get_son_of_anton_dir

    return get_son_of_anton_dir("cache/delegation", "delegation_cache") / "live"
...
class LiveTranscriptWriter:
    ...
    def __init__(self, delegation_id: str, task_index: int, goal: str,
        ...
        try:
            ...
            header = [
                "=== Son of Anton subagent live transcript ===",
