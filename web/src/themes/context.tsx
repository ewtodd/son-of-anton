...
const STORAGE_KEY = "renco-dashboard-theme";
...
const FONT_STORAGE_KEY = "renco-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `renco_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "renco-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-renco-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-renco-theme-font", "true");
