"""``son-of-anton hooks`` subcommand parser.
...
def build_hooks_parser(subparsers, *, cmd_hooks: Callable) -> None:
    ...
    hooks_parser = subparsers.add_parser(
        ...
        description=(
            "Inspect shell-script hooks declared in ~/.son-of-anton/config.yaml, "
            "test them against synthetic payloads, and manage the first-use "
            "consent allowlist at ~/.son-of-anton/shell-hooks-allowlist.json."
        ),
    )
