...
class SessionSearchMixin:
    ...
    def search_messages(
        ...
        Threshold: SON_OF_ANTON_SEARCH_SLOW_MS (default 1000; 0 logs every call).
        """
        started = time.time()
        rows = None
        try:
            ...
            try:
                threshold = float(os.getenv("SON_OF_ANTON_SEARCH_SLOW_MS", "1000"))
    ...
    def optimize_fts(self) -> int:
        ...
        disabled via ``SON_OF_ANTON_DISABLE_FTS_TRIGRAM`` or not yet created), so
