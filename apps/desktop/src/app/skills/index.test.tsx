...
import type * as RencoApi from '@/renco'
...
// observable.
vi.mock('@/renco', async importOriginal => ({
  ...(await importOriginal<typeof RencoApi>()),
...
describe('SkillsView toolset management', () => {
    ...
    await act(async () => {
      window.dispatchEvent(
        new MessageEvent('message', {
          data: { type: 'renco-skill-pick', name: 'web-research', identifier: 'web-research' },
          origin: 'https://renco-agent.nousresearch.com'
        })
      )
    })
  ...
  it('offers (connection, profile) scope rows on multi-connection desktops', async () => {
    ...
    ;(window as { rencoDesktop?: unknown }).rencoDesktop = { connections, getAgentRoster }
