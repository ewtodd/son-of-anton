"""Tests for the ``son-of-anton prompt-size`` diagnostic (issue #34667)."""
...
from son_of_anton_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(son_of_anton_home, memory_text="", user_text=""):
    mem_dir = son_of_anton_home / "memories"
...
def _seed_skill(son_of_anton_home, name, description):
    skill_dir = son_of_anton_home / "skills" / "demo" / name
