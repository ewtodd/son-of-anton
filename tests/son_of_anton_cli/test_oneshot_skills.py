...
The oneshot path builds its AIAgent directly (bypassing SonOfAntonCLI), so the
...
from son_of_anton_cli.oneshot import _build_preloaded_skills_prompt, _normalize_skills
