"""Tests for ``son-of-anton approvals suggest`` (son_of_anton_cli/approvals_suggest.py).

Approval history in Son of Anton is implied, not ledgered: the session DB
...
from son_of_anton_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
