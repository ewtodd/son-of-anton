...
class TestRealWorldOutput:
    ...
    REAL = (
        ...
        "Uploaded son-of-anton-temp-hello (0.74 sec)\n"
        "Deployed son-of-anton-temp-hello triggers (0.42 sec)\n"
        "  https://son-of-anton-temp-hello.serene-temple.workers.dev\n"
    )
    ...
    def test_all_fields_from_real_output(self):
        r = pdo.parse(self.REAL)
        assert r["live_url"] == "https://son-of-anton-temp-hello.serene-temple.workers.dev"
