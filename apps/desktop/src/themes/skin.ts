/**
 * Renco skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$RENCO_HOME/skins/` (or a
 * built-in) resolved by `renco_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Renco authors from a prompt lights up all three surfaces from one file.
 *
...
import type { RencoSkin, SkinColors } from '@renco/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: RencoSkin): DesktopTheme | null {
